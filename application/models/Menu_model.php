...
class Menu_model extends CI_Model {
    ...
    public function getDynamicLinks($params) {
        ...
        }else if ($params['page_url'] == 'set_tech_run.php') {
            $page = '/tech_run/set';
        }
        ...
        }else if ($params['page_url'] == 'daily/overdue_qld_jobs') {
            $page = '/daily/overdue_qld_jobs';
        ...
        } else if ($params['page_url'] == 'agency_api/linked_properties') { // Linked Properties
            $page = '/agency_api/linked_properties';
        ...
        }else if ($params['page_url'] == 'console/unprocessed_webhooks') { // Console Property Info
            $page = '/console/unprocessed_webhooks';
        ...
        }else if ($params['page_url'] == 'property_tree/agency_preference') { // Pme updated tenants
            $page = '/property_tree/agency_preference';
        }
