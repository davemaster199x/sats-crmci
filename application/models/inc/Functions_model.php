...
class Functions_model extends CI_Model
{
    ...
    public function send_letters_no_tenant_email($params){
        ...
        if( $new_job_email_to_agent == 1 ){
            ...
            $sendParams = array(
                ...
                'from_txt' => config_item('company_full_name'),
    ...
    public function send_letters_send_tenant_sms($params){
        ...
        $body = config_item('company_name_short') . " have been asked to test the smoke alarms at the property you occupy. Our staff will contact you shortly to make an appointment. Any questions {$cntry->tenant_number}";

        $headers .= "To: {$to}" . "\r\n";
        $headers .= "From: " . config_item('company_name_short') . " - " . config_item('company_full_name') . " <{$cntry->outgoing_email}>" . "\r\n";
