            ...
            $.ajax({
                ...
                success: (data) => {
                   ...
                   /* totalpropsPerTechCountTd.text("(Avg.) "+techRegions.reduce((total, techRegion) => {
                    ...
                    // properties per tech
                    var props_per_tech = ( property_count_total / technician_count_total );

                    totalpropsPerTechCountTd.text("(Avg.) "+props_per_tech.toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ",") );
                    ...
                    // surplus capacity
                    var surplus_capacity = techRegions.reduce((total, techRegion) => {
                    ...
                    totalsurplusCountTd.text(surplus_capacity.toFixed(0).toString().replace(/\B(?=(\d{3})+(?!\d))/g, ","));
