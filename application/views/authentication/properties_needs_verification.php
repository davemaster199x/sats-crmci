			...
			jQuery.ajax({
				...
				if( ret.length > 0 ){
					...
					dup_html += ''+
						...
						'</li>';
					dup_html +='</ul><br />'+
					'This property already exists with <a href="/view_agency_details.php?id='+ret[0].dup_agency_id+'">'+ret[0].dup_agency_name+'</a><br /><br />'+													
					'Would you like to connect it and move to <a href="/view_agency_details.php?id='+agency_id+'">'+agency_name+'</a>?'+
					'</div>';
