				...
				<div class="col-md-6 pme_main_div">
					...
					<div class="col-md-12">
						...
						<?php 
							 ...
							 * public 'PropertyAddress1' = object(stdClass)[2206] > this is empty address1 for example
							 */
							$palaceAddress1 = (is_string($lotList->PropertyAddress1)) ? $lotList->PropertyAddress1 : '';
							$palaceAddress2 = (is_string($lotList->PropertyAddress2)) ? $lotList->PropertyAddress2 : '';
							$palaceAddress3 = (is_string($lotList->PropertyAddress3)) ? $lotList->PropertyAddress3 : '';
							$palaceAddress4 = (is_string($lotList->PropertyAddress4)) ? $lotList->PropertyAddress4 : '';
							$palacePostcode = (is_string($lotList->PropertyPostCode)) ? $lotList->PropertyPostCode : '';
							$palacePropertyName = (is_string($lotList->PropertyName)) ? $lotList->PropertyName : '';

							$fullAdd = $palaceAddress1 . " " . $palaceAddress2 . ", " . $palaceAddress3 . " " . $palaceAddress4 . " " . $palacePostcode;
						?>
						<table class="table table-striped table-bordered " id="myTable">
							<thead>
								<tr>
