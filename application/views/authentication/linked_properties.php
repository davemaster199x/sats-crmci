		...
		<div class="body-typical-body">
			<div class="table-responsive">
				...
				<table class="table table-hover main-table linked_prop_tbl">
					...
					<?php                    
					$i = 1;
					$apiConnectedIds = array('pme_prop_id', 'palace_prop_id', 'ourtradie_prop_id', 'pt_prop_id','console');	
                    ...
                    foreach ($apiConnectedIds as $ids) {
                    	...
                    	}else if ($ids == "console") { // console
                    		if (!is_null($row->cp_id) && !empty($row->cp_id)) {
                    			$linkedApi = "Console";
                    			$countApiConnected++;
                    			$linkId = $row->console_prop_id;
                    		}
                    	}
    				}				
                    ?>
						<tr>   
							<td>
                                <a href='/properties/details/?id=<?php echo $row->property_id; ?>' target='_blank'>
