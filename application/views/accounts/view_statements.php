            ...
            <div class="form-row">
                ...
                <div class="col-2">
                    <?php if ($search_flag == 1) { ?>
                        ...
                        <label>&nbsp;</label>
                        <a target="_blank" href="/accounts/pdfexport_statement/?a=<?php echo rawurlencode(HashEncryption::encodeString($agency_id)); ?>&f=<?php echo rawurlencode(HashEncryption::encodeString($from)); ?>&t=<?php echo rawurlencode(HashEncryption::encodeString($to)); ?>&p=<?php echo rawurlencode(HashEncryption::encodeString($phrase)); ?>">
                            <button type='submit' class='btn btn-inline' id="btn_display_statement">
                                <img class="inner_icon" src="/images/button_icons/pdf_white.png">
                                Display Statement
                            </button>
                            ...
                            foreach ($statements as $row) {
                                ...
                                <tr class="body_tr jalign_left" <?php echo $row_color; ?>>
                                    ...
                                    <td>
                                        ...
                                        <?php
                                            $encrypted_job_id = rawurlencode(HashEncryption::encodeString($row['jid']));
//                                            echo $this->gherxlib->crmLink('view_combined', $row['jid'], '<i style="color:#0082c6" class="fa fa-file-pdf-o"></i>');
                                            echo "<a href='/pdf/combined/{$encrypted_job_id}'><i style='color:#0082c6' class='fa fa-file-pdf-o'></i></a>";
                                        ?> |
                                        <?php echo $this->gherxlib->crmLink('vjd', $row['jid'], $bpay_ref_code); ?>
                                    </td>			
                                    <td>

                                                                                                                                <!--<a href="/properties/details/?id=<?php echo $row['property_id']; ?>"><?php echo "{$row['p_address_1']} {$row['p_address_2']}, {$row['p_address_3']}"; ?></a>-->
                                        <?Php
                    ...
                    <table class="table table-hover main-table">
                        ...
                        foreach($agen_pay_sql->result() as $index => $agen_pay_row){ 
                            ...
                            <tr>
                                ...
                                <td><?php echo "Payment received {$agency_pay_date}. Please email a remittance advice to {make_email('accounts')}"; ?></td>
