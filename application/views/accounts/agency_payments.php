...
<div id="about_page_fb" class="fancybox" style="display:none;" >
	...
	<p>
    This page is to record all payments into <?=$this->config->item('company_name_short')?>. We record if we payment is visible in bank account OR we have received a remittance
	</p>
    <pre>
