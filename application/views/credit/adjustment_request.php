        ...
        <div class="row" id="adjustment_request_div">
            <div class="col-md-12 col-lg-6 columns">
                ...
                <div id="is_refund_request_only_div" class="form-group row">
                    <div class="col">
                        Please submit a refund request.  If the invoice is not in a credit balance, please email <?php echo make_email('accounts'); ?> to submit the request                    
                    </div>
                </div>
                ...
                <div class="form-group row bank_details_info_row">                    
                    <div class="col">
                        Please request bank details in writing and forward to <?php echo make_email('accounts'); ?>                        
                    </div>
                </div>
            ...
            <h4>Requirements from <?=$this->config->item('company_name_short')?> staff</h4>
