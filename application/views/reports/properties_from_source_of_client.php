						...
						<tr>
                            ...
                            <th>
                                ...
                                <a 
                                    data-toggle="tooltip" 
                                    class="a_link <?php echo $sort ?>" 
                                    href="<?php echo "/reports/properties_from_source_of_client/?sort_header=1&order_by=pfoc.added_date&sort={$toggle_sort}&".http_build_query($header_link_params); ?>"
                                >
                                    <em class="fa fa-sort-<?php echo $sort; ?>"></em>
                                </a>
                            </th>
                            <th>
                                ...
                                <a 
                                    data-toggle="tooltip" 
                                    class="a_link <?php echo $sort ?>" 
                                    href="<?php echo "/reports/properties_from_source_of_client/?sort_header=1&sort_multiple=1&order_by=p.nlm_timestamp,ps.status_changed&sort={$toggle_sort}&".http_build_query($header_link_params); ?>"
                                >
                                    <em class="fa fa-sort-<?php echo $sort; ?>"></em>
                                </a>
                            </th>
