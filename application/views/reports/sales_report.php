			...
			<div class="for-groupss row">
				<div class="col-md-12 columns">
					<div class="row">
                        ...
                        <div class="col-md-6">
                            <?php             
                            // only show to staff with permission and only show on sales commission new version         
                            if( $this->system_model->can_edit_account(6) == true && $sales_commission_ver == 'new' ){ ?>
	...
	<section>
		<div class="body-typical-body">
            ...
            <div class="report_head">
                ...
                <p>This report shows totals that are <?=$this->config->item('company_name_short')?> to service. These numbers do not include totals for properties that are marked DIY, No Response or Other Provider</p>
            </div>
			...
			<div class="table-responsive">
                                    ...
                                    foreach($ajt_arr as $row){
                                        ...
                                        if($this->config->item('country')==2){
                                            if($row['id']==2){
                                                ...
                                                echo "<th class='service_count_elem'>{$row['short_name']}</th>";
                                            }
                                        }else{
                                            //echo "<th>{$row['short_name_wspace']}</th>";
                                            echo "<th class='service_count_elem'>{$row['short_name']}</th>";
                        ...
                        <tbody>
                            ...
                            <tr style="background:#f6f8fa;">
                                ...
                                $awaw_ctn = 0;
                                    ...
                                    if($awaw_ctn==0){
                                    ?>
                                    <td class="service_count_elem">&nbsp;</td>
                                <?php	
                                    }
                                    }else{
                                        echo " <td class='service_count_elem'>&nbsp;</td>";
                                    }
                                $awaw_ctn++;
                                    }
                                ?>
                ...
                <div class="text-center mt-1">
                    <button class="btn" id="show_indv_serv_count">Show Individual Service Count</button>
                </div>              
                ...
                <?php if($this->config->item('country')==1){ ?>
                 ...
                 <div id="search_result">
                    <div class="table_top_head">Sales Upgrades</div>
                    <table class="table table-hover main-table table_border">
                        <thead>
                            <tr>
                                <th>Staff</th>
				...
				<table class="table table-hover main-table table_border">
					<thead>
						<tr>
                            ...
                            foreach( $get_sales_report_sql as $al ){ ?>
                                <th data-contact_type_id = <?php   echo $al['main_log_type_id']; ?>><?php echo $al['contact_type']; ?></th>
                            <?php	
                            }
                            ?>
                            <th>Total</th>
                        ...
                        <tr>
                            ...
                            foreach( $get_sales_report_sql as $index => $al ){ 
                                ...
                                <td>
                                    ...
                                    echo $sales_report_count = $sales_report_count_sql['sales_report_count'];
                                    $sales_report_count_row_tot += $sales_report_count;
                                    $sales_report_count_tot_arr[$al['contact_type']] += $sales_report_count;
                                    ?>
                                </td>
                                <?php	
                            }
                            ?>
                            <td><?php echo $sales_report_count_row_tot; ?></td>
                        </tr>

                    <?php
                        $grand_total += $sales_report_count_row_tot;
                        }
                    ?>
                    ...
                    <tfoot>
                        <tr>
                            <th>Total</th>                            
                            <?php
                            foreach( $sales_report_count_tot_arr as $al ){ 
                            ?>
                                <th><?php echo $al; ?></th>
                            <?php	
                            }
...
.fixed-table-body .table tfoot th {
  border-bottom: none;
  padding-top: 10px;
  padding-bottom: 9px;
  background: #f6f8fa;
...
jQuery(document).ready(function(){
    ...
    jQuery("#show_indv_serv_count").click(function(){
        var orig_txt = 'Show Individual Service Count';
        var btn_dom = jQuery(this);
        if( btn_dom.text() == orig_txt ){
            jQuery(".service_count_elem").show();
            btn_dom.text('Hide Individual Service Count');
        }else{
            jQuery(".service_count_elem").hide();
            btn_dom.text(orig_txt);
        }
    });
