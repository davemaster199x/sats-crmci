                    ...
                    <div class="col-mdd-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class='d-flex flex-row justify-content-start align-items-center h-100 text-lg-start'>
                                ...
                                <div class="ml-4">
                                    <p class="font-weight-bold">Ratio Percentage <span class="badge badge-pill badge-primary">50%</span></p>	
                                </div>
                            </div>
					...
					<tbody>
                        ...
                        ?>
                                ...
                                <tr>                                    
                                    ...
                                    <td><?php echo $this->gherxlib->getAge($row['jcreated'], $row['jdate']);  ?></td>      
                                    <td><?php echo $this->gherxlib->getDaysMissedBy($row['jdate'],$row['due_date']); ?></td>                             
                                    <td>                         
                                    ...
                                    <td>
                                        <a href="<?php echo $this->config->item('crmci_link') ?>/jobs/details/<?php echo $row['jid']; ?>">
                                            <?php echo $row['job_type']; ?>
                                        </a>                                        
                                    </td>
                                    <td><?php echo ( $row['jdate'] <= $row['due_date'] )?'<span class="text-success">Yes</span>':'<span class="text-danger">No</span>';  ?></td>                                                                 
                                </tr>
