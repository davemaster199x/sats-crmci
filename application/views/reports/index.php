        ...
        <div class="row">
            ...
            <div class="col-md-6 columns">
                ...
                <section class="widget widget-reports">
                    ...
                    <div>
                        <ul>
                            <li><a href="/properties/active_job_properties">Properties with an Active Service</a></li>
                            ...
                            <li><a href="/properties/api_workorders">API Workorders (Not Active) </a></li>
                            <li><a href="/properties/deactivated_properties">Deactivated Properties</a></li>
                            <li><a href="/reports/most_recent_job_property_report">Most Recent Completed Jobs Report - Move to Jobs report </a></li>
                            <li><a href="/reports/new_properties_report">New Properties Report</a></li>
                            <li><a href="/reports/no_retest_date">Properties with No Retest Date</a></li>
                            <?php
                            if( $_ENV['THEME'] == 'sats' ){ // SATS only ?>
                                <li><a href="/reports/agencies_from_source_of_client">Properties from Purchased Agencies</a></li>
                                <li><a href="/reports/properties_from_source_of_client">Properties From Source of Client</a></li>
                            <?php
                            }
                            ?>                                                                                    
                            <!--<li><a href="/reports/properties_missing_variation">Properties Missing Variation</a></li>-->                                                      
                            <li><a href="/reports/property_gained_and_lost">Properties Gained or Lost</a></li>
                            <li><a href="/reports/property_missed_renewal">Properties that Missed Renewal</a></li>
                            <li><a href="/properties/serviced_to_sats">Property Services Updated to <?=$this->config->item('COMPANY_NAME_SHORT')?></a></li>
                            <li><a href="/reports/property_variation">Property Variation Report</a></li>                                                                                                                                                
                            <li><a href="/reports/tracking_tenant_lease_periods">Tracking Tenant Lease Periods</a></li>
                ...
                <section class="widget widget-reports">
                    ...
                    <div>
                        <ul>               
                            ...
                            <li><a href="/reports/compliance_report_nsw_act">Compliance Report (EXC. QLD)</a></li>
                            ...
                            <?php
                            if( $_ENV['THEME'] == 'sats' && config_item('country') == 1 ){ // SATS AU only ?>
                            ...
                            ?>                            
                            <li><a href="/reports/invoiced_but_not_yet_on_myob">Invoiced but not yet on MYOB</a></li>  
                            <li><a href="/daily/overdue_qld_jobs">Overdue QLD Jobs</a></li>   
                            ...
                            <li><a href="/reports/jobs_not_exported_to_myob">Jobs not exported to MYOB</a></li>
                        </ul>
                    </div>
                </section>
                ...
                <section class="widget widget-reports">
                    ...
                    <div>
                        <ul>       
                            ...
                            <li><a href="/reports/contractors">Contractor List</a></li>                                               
                            ...
                            <li><a href="/stock/suppliers">Supplier List</a></li>
                ...
                <section class="widget widget-reports">
                    ...
                    <div>
                        <ul>
                            ...
                            <li><a href="/reports/cron_report">Automated Functions (Crons) Report</a></li>
                            <li><a href="/reports/figures">Monthly Figures</a></li>   
                ...
                <section class="widget widget-reports">
                    ...
                    <div>
                        <ul>
                            ...
                            <?php
                            if( $_ENV['THEME'] == 'sats' && $this->config->item('country') == 1 ){ // AU only ?>
                            ...
                            <li><a href="/agency/subscription_billing_agencies">Subscription Billing Clients</a></li>
