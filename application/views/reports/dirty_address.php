					...
					<tbody>
						...
						if($lists->num_rows()>0){
							...
							if( strtoupper($row['address_3']) == $row['address_3'] ){
								...
								$suburb_col_bg = "redRowBg";
							}else if( strpos($row['address_3'],',') || strpos($row['address_3'],'(') || strpos($row['address_3'],')') ){ // comma and ()
								$suburb_col_bg = "redRowBg";
                        ...
                        ?>
                                <tr data-cnt="<?php echo $cnt; ?>">
                                    ...
                                    <td class="<?php echo ( strtoupper($row['address_2']) == $row['address_2'] || strpos($row['address_2'],'-') !== false || strpos($row['address_2'],',') !== false || strpos($row['address_2'],'(') || strpos($row['address_2'],')') ) ? 'redRowBg' : 'ew' ?>">
