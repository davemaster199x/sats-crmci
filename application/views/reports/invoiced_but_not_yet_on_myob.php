                ...
                <div class="col-lg-10 col-md-12 columns">
                    ...
                    <div class="row">
                        ...
                        <div class="col-mdd-3">
							...
							<input name="from_date" class="flatpickr form-control flatpickr-input" data-allow-input="true" id="flatpickr" type="text"  value="<?php echo $this->input->get_post('from_date'); ?>">
						</div>

                        <div class="col-mdd-3">
							<label for="date_select">To</label>
							<input name="to_date" class="flatpickr form-control flatpickr-input" data-allow-input="true" id="flatpickr" type="text"  value="<?php echo $this->input->get_post('to_date'); ?>">
						</div>

                        <div class="col-md-3 columns">
                            <label id="zero_jobs_included_lbl"><?php echo ( $this->input->get_post('zero_jobs_included') == 1 )?'$0 Jobs Included':'$0 Jobs Excluded'; ?></label>                              
                            <div class="checkbox-toggle">
                                <input type="checkbox" id="zero_jobs_included" name="zero_jobs_included" value="1" <?php echo ( $this->input->get_post('zero_jobs_included') == 1 )?'checked':null; ?> />
                                <label for="zero_jobs_included"></label>
                            </div>
                        </div>
	...
	<section>
		<div class="body-typical-body">
			<div class="table-responsive">
                ...
                <button type="button" class="btn float-right">Renew</button>
