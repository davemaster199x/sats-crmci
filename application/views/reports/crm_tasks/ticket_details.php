                    ...
                    <form action="/reports/ticket_response/" enctype="multipart/form-data"  method="post">
                        <table class="table">  
                            ...
                            <tr>
                                <td>Category:</td>
                                <td>
                                    <select id="category" name="category"  class="form-control field_g2" required>
                                        <option value="">---</option>
                                        <?php
                                        foreach( $ticket_category_q->result() as $ticket_category_row ){ ?>
                                            <option value="<?php echo $ticket_category_row->id; ?>" <?php echo ( $ticket_category_row->id == $crm_task_row->category )?'selected':null; ?>><?php echo $ticket_category_row->category_name; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                                ...
                                <td>                                    
                                     <select id="help_topic" name="help_topic"  class="form-control field_g2" required>
                                        ...
                                        foreach( $crm_task_help_topic_sql->result() as $crm_task_help_topic_row ){ ?>
                                            <option value="<?php echo $crm_task_help_topic_row->id; ?>" <?php echo ( $crm_task_help_topic_row->id == $crm_task_row->sub_category )?'selected':null; ?>><?php echo $crm_task_help_topic_row->sub_category_name; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
