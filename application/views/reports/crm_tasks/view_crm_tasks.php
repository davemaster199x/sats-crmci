                    ...
                    <form method=POST action="/reports/view_crm_tasks" class="form-row">
                        ...
                        <div class="col">
                            ...
                            <select name="category" class="form-control">
                                <option value="">---</option>   
                                <?php
                                foreach( $ticket_category_q->result() as $ticket_category_q_row ){ ?>
                                    <option value="<?php echo $ticket_category_q_row->id; ?>" <?php echo ( $ticket_category_q_row->id == $this->input->get_post('category') )?'selected':null; ?>><?php echo $ticket_category_q_row->category_name; ?></option>
                                <?php
                                }
                                ?>                   
                            </select>
                        ...
                        <div class="col">
                            ...
                            <select name="help_topic" class="form-control">
                                ...
                                foreach( $crm_task_help_topic_sql->result() as $crm_task_help_topic_row ){ ?>
                                    <option value="<?php echo $crm_task_help_topic_row->id; ?>" <?php echo ( $crm_task_help_topic_row->id == $this->input->get_post('help_topic') )?'selected':null; ?>><?php echo $crm_task_help_topic_row->sub_category_name; ?></option>
                                <?php
                                }
                                ?>                         
                            </select>
                        ...
                        if (count($tasks) > 0) {
                            foreach ($tasks as $row) {
                                ...
                                <tr>
                                    ...
                                    <td><?php echo ( $row['sub_category'] > 0 )?$row['ctht_help_topic']:'Other'; ?></td>
                                    <td>
                                        <?php                             
                                        // ticket priority
...
<div id="add_task" class="fancybox" style="display:none; width: 50%;" >
    ...
    <div id="add_task_div" class="addproperty formholder">
        <form id="add_task_form" method="post" action="/reports/update_crm_task_action_form_submit" enctype="multipart/form-data">
            ...
            <div class="row mb-3">     
                <div class="col-md-4">
                    <label class="addlabel" for="#"><span class="text-danger">*</span>Category</label>
                    <select class="form-control" id="ticket_category" name="ticket_category" required>
                        <option value="">---</option>
                        <?php
                        foreach( $ticket_category_q->result() as $ticket_category__row ){ ?>
                            <option value="<?php echo $ticket_category__row->id; ?>"><?php echo $ticket_category__row->category_name; ?></option>
                        <?php
                        }
                        ?>
                    </select>
                ...
                <div class="col-md-4">
                    <label class="addlabel" for="title"><span class="text-danger">*</span> Sub Category</label>
                    <select id="help_topic" name="help_topic"  class="form-control field_g2" required>
                        <option value="">---</option>
                        <?php
                        foreach( $crm_task_help_topic_sql->result() as $crm_task_help_topic_row ){ ?>
                            <option value="<?php echo $crm_task_help_topic_row->id; ?>"><?php echo $crm_task_help_topic_row->sub_category_name; ?></option>
                        <?php
                        }
                        ?>
                    </select>
            ...
            <div class="row mb-3">
                <div class="col">
                    <label class="addlabel" for="title"><span class="text-danger">*</span> Issue Details</label>
                    <textarea class="addtextarea form-control" name="describe_issue" id="describe_issue" style="height: 150px;" required></textarea>
                </div>                
            </div>
