<div class="box-typical box-typical-padding">
	...
	<header class="box-typical-header">
		...
		echo form_open($uri."/?ver={$this->input->get_post('ver')}",$form_attr);
		?>
				...
				<div class="col-md-10 columns">
					<div class="row">	
						...
						<div class="mr-2">
							<label class="col-sm-12 form-control-label">&nbsp;</label>
							<?php
							if( $this->input->get_post('ver') == 'new' ){
								$ver_link = 'old';
								$ver_btn = 'Old Version';
							}else{
								$ver_link = 'new';
							...
							?>
							<a href="/reports/property_commissions/?ver=<?php echo $ver_link; ?>">
								<button type="button" name="switch_version_btn" class="btn"><?php echo $ver_btn; ?></button>
							</a>							
						</div>
						-->
						...
						<div class="mr-2">
							<label class="col-sm-12 form-control-label">&nbsp;</label>
							<a href="/reports/property_commissions_comparison">
								<button type="button" class="btn">See Missing Properties</button>
							</a>							
						</div>						
