                    ...
                    <div class="col-sm-3">
                        <select  class="form-control" name="type_of_leave" id="type_of_leave">
                            ...
                            foreach( $leave_types_sql->result() as $leave_types_row ){ ?>
                                <option value="<?php echo $leave_types_row->leave_type_id; ?>" <?php echo ( $leave_types_row->leave_type_id == $row['type_of_leave'] )?'selected':null; ?>><?php echo $leave_types_row->leave_name; ?></option>
                            <?php
                            }
                            ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-3">
                            <select  class="form-control <?php echo ($row['type_of_leave']==2)?'g_validate':NULL; ?>" name="backup_leave" id="backup_leave">
                                ...
                                $leave_types_sql = $this->system_model->get_leave_types($param_obj);
                                foreach( $leave_types_sql->result() as $leave_types_row ){ ?>
                                    <option value="<?php echo $leave_types_row->leave_type_id; ?>" <?php echo ( $leave_types_row->leave_type_id == $row['backup_leave'] )?'selected':null; ?>><?php echo $leave_types_row->leave_name; ?></option>
                                <?php
                                }
                                ?>
                            </select>
                        ...
                        <div class="row">
                            <div class="col-md-4 columns">
                                <div class="checkbox">
                                    ...
                                    <a href="/calendar/add_new_entry/<?= $this->uri->segment(3)?>"><span class="fa fa-calendar tticon"></span></a>
