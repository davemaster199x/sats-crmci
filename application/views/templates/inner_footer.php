	...
	<?php
		...
		<div class="form-group row">
			<select id="search_type" name="search_type" class="form-control">
				...
				<option value="8">Tenant Email</option>
			</select>
		</div>
		<div class="form-group row">
...
<script>
	...
	$(document).ready(function() {
		...
		*/
		...
		//jQuery(".page-content a[href*='view_property_details.php']").each(function(){
		//	var a_dom = jQuery(this);
		//	var href = a_dom.attr("href");
		//	var currentURL = window.location.href;
        //
		//	var searchString = "properties/details"; // Exclude VPD link cause it needs to add the OLD Link here
		//
		//	if (href.includes("view_property_details.php")) {
		...
		//			if (idValue) {
		//				// Replace the entire href with a new link that includes the extracted 'id'
		//				var newHref = "/properties/details/?id=" + idValue + "&tab=1"; // Replace with your new link
		//				a_dom.attr("href", newHref);
		//			}
		//		}
		//	}
        //
		...
		//			reconstruct_url = url_obj.origin+'/link_login.php?staff_id='+staff_id+'&page='+page;
