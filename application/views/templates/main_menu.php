	    ...
	    <ul class="side-menu-list">
	       ...
	       <li>
			...
			<?php
                ...
                <?php if(in_array($staff_class,[2,6])): ?>
                <li class="purple with-sub menu_parent_li">
                    <span class="menu_name"> <i class="fa fa-terminal"></i> <span class="lbl" data-menu_id="20">Developers</span></span>
                    <ul>
                        <li><a href="/dev/page-speed/" class="menu_link">Page Speed</a></li>
                        <li><a href="/dev/session-logs/" class="menu_link">Session Logs</a></li>
                    </ul>
                </li>
				<?php endif; ?>
