	...
	<section>
        ...
        <!-- Add New Resrouces Fancybox END -->
         ...
         <div id="add_edit_heading_fancybox" style="display:none;width:500px;">
                    ...
                    if ($staff_class == 2) { // only global user
                    ?>
                        <div class="form-group row rs_header_parent">
                            <div class="col-md-10">
                                <input type="text" class="fname form-control pm_name" id="add_header_name" value="" placeholder="Add New Header">	
                            </div>
                            <div class="col-md-2">
                                <a href="#" class="btn_add_rh"><i class="font-icon font-icon-check-bird color-green"></i></a>
                            </div>
                        </div>
                    <?php } ?>
                    <div class="form-group">
...
$(function(){
    ...
    jQuery(".btn_add_rh").click(function(e){
        e.preventDefault();
        var sh_name = $("#add_header_name").val();
        ...
        swal({
            ...
            function(isConfirm) {
                if (isConfirm) {
                    ...
                    jQuery.ajax({
                        type: "POST",
                        url: "/admin/ajax_add_resources_header",
                        dataType: 'json',
                        data: {
                            sh_name: sh_name
                        }
