...
<p>
    ...
    OR you would like for <?=$this->config->item('company_name_short')?> to upgrade the property to Interconnected Smoke Alarms, please log into the <?=$this->config->item('company_name_short')?> portal then follow this 
    link: <a href="<?php echo config_item('agency_link'); ?>/reports/qld_upgrade"><?=$this->config->item('company_name_short')?> Agency Portal</a>
</p>

<p>From here you can view and approve quotes or advise <?=$this->config->item('company_name_short')?> that the property has already been upgraded.</p>
