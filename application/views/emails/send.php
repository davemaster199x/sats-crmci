                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <p class="form-control-static">
                            <input type="text" class="form-control" id="from" name="from" value="<?php echo make_email('info'); ?>" />
                        </p>
                    </div>
                </div>
                        ...
                        <div id="attachment_div">
                            ...
                            <div class="d-flex flex-row">
                                ...
                                if( $job_row->p_state == 'QLD' ){ ?>
                                    ...
                                    <div class="checkbox mr-2">
                                        <input type="checkbox" id="economical_quote" name="economical_quote" value="1" />
                                        <label for="economical_quote">Economical Quote</label>
                                    </div>
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group row">  
                    ...
                    <div class="col-sm-5 tags_div">
                        ...
                        <?php if(!empty($property_managers_email)): ?>
                        <button type="button" 
                            class="btn tag_btn" 
                            data-email="<?php echo $property_managers_email; ?>"
                            data-tag_val=""
                        >
...
jQuery(document).ready(function(){
    ...
    jQuery("#category").on('change', function() {
        ...
        $.ajax({
            ...
            switch (templates_type_id) {
                case '3': // Accounts
                    jQuery("#from").val('<?php echo make_email('accounts'); ?>');
                    break;
                case '5': // Operations
                    <?php if( $this->config->item('country') == 1 ): // AU ?>
                        jQuery("#from").val('<?php echo make_email('operations') ?>');
                    <?php elseif( $this->config->item('country') == 2 ): // NZ ?>
                        jQuery("#from").val('<?php echo make_email('info'); ?>');
                    <?php endif; ?>
                    break;
                case '9': // Call Centre
                    jQuery("#from").val('<?php echo make_email('bookings') ?>');
                    break;
                case '1': // Sales
                    jQuery("#from").val('<?php echo make_email('sales') ?>');
                    break;
                case '7': // Scheduling
                    jQuery("#from").val('<?php echo make_email('operations') ?>');
                    break;
                default:
                    console.log("Default case: Setting default email");
                    jQuery("#from").val('<?php echo make_email('info'); ?>'); // Default Email
            }
