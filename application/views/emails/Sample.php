...
<p>Dear test name,</p>
<p>You have added a new property through the <?=$this->config->item('company_name_short')?> Agency portal:</p>
...
<h3>Tenants:</h3>
   ...
   <h3>Services:</h3>
    <ul style="margin: 0">
                ...
                <li>Bundle services 100.00 - <?=$this->config->item('company_name_short')?></li>
