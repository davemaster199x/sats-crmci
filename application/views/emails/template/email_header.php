                                                ...
                                                <table style="width: 100%;">
                                                    <tr>
                                                        <td style="padding: 25px 25px;text-align:left;background:#fff;">
                                                            <a href="<?= base_url(); ?>">
																<img width="270" height="85" style="max-width: 270px; width: 100%; height: auto;" src="<?= theme('images/logo_login.png'); ?>" alt="<?=get_app_email_from_header()?>">
															</a>
                                                        </td>
                                                        <td style="padding: 25px 25px;text-align:right;background:#fff;">
                                                           
														<strong style="font-size:22px; color:<?= config_item('theme') == 'sas' ? '#00607f' : '#b4151b'; ?>">
                                                            <?php
																// get country data
