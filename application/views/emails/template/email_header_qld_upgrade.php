                                                ...
                                                <table style="width: 100%;">
                                                    <tr>
                                                        ...
                                                        if ($this->config->item('country') == 1) {
                                                            $link = "http://{$this->config->item('base_domain')}/";
                                                        } else {
                                                            $link = "https://{$this->config->item('base_domain')}/";
                                                        }
                                                        ?>
                                                            <a href="<?php echo $link;?>">  
																<img  style="width: 175px;" src="<?php echo base_url('/images/logo_login.png'); ?>">
															</a>
                                                        </td>
                                                        <td style="padding: 25px 25px;text-align:right;background:#fff;">
                                                           
														<strong style="font-size:14px; color:#b4151b;">
                                                            <?php
																// get country data
