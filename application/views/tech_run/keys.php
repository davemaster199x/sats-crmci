		...
		<div class="body-typical-body">
			<div class="table-responsive">
                ...
                foreach( $agency_sql->result() as $a_row ){ 
                    ...
                    <div>
                        <h2 class="float-left mr-3"><?php echo str_replace('*do not use*','',$a_row->agency_name); ?></h2>   
                        <?php
                            if( $a_row->agen_add_id > 0 ){ // key address

								$agency_address = "{$a_row->agen_add_street_num} {$a_row->agen_add_street_name}, {$a_row->agen_add_suburb}"; 

							}else{ // default

								$agency_address = "{$a_row->a_address_1} {$a_row->a_address_2}, {$a_row->a_address_3}"; 

							}	
                            ?>      
                        <h4 class="dynamic_agency_address">(<?php echo $agency_address; ?>)</h4>                                       
                    </div>
