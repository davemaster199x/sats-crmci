<h4>Run Sheet</h4>
	...
	<ul class="about_page_li">
		...
		<li><img class="row_icons" title="No Tenants" src="/images/icons-jobs/upgrade_colored.png"> - This is an upgrade to interconnected job (NEW QLD Legislation)</li>
		<li><img class="row_icons" title="No Tenants" src="/images/icons-jobs/240v_colored.png"> - This job requires an electrician</li>
		<li><img class="row_icons" title="No Tenants" src="/images/icons-jobs/fr_colored.png"> - This is a Repair job</li>
	...
	<ul class="about_page_li">	
		...
		<li><span style="background-color: orange;">Orange Highlight</span> - Job has not completed reason</li>
