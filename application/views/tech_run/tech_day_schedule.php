				 ...
				 <div class="col-md-4 columns text-right">
						<div class="jobs-completed_block">	
							...
							if( $staff['working_hours'] != '' ){ ?>
								<span class="mr-3">Working Hours: <?php echo $staff['working_hours']; ?></span>	
							<?php
							}
							?>									
				...
				<div class="row">
						...
						<div class="col-md-8 columns text-right">
							...
							<div style="float:right;padding-top:5px;">
								...
								<span class="mr-2">
									<a href="/tech_run/map/?tr_id=<?php echo $tr_id; ?>">
										Map: <span class="fa fa-map-marker" style="font-size:18px;"></span>
									</a>
								</span>

								<span>
									<a href="/tech_run/set/?tr_id=<?php echo $tr_id; ?>">
										...
										if( $showRow ==1 ){
											...
											if( $row2['key_access_required'] == 1 ){ 
												...
												if( $row2['job_entry_notice']==1 ){
													$encoded_string = HashEncryption::encodeString($row2['jid']);
                                                    $en_link_orig = "{$this->config->item('crm_link')}/pdf/entry_notice/{$encoded_string}"; // orig link
													$key_td .= "
...
<script type="text/javascript">
		...
		jQuery(document).ready(function(){
			...
			$('.btn-kms').click(function(){
				...
				if( count($jobs_no_key_pickup_arr) > 0 && $tech_run_row->run_complete == 1 ){ 
