			...
			<div class="row">
				...
				<span class="col-md-4 text-center">
					...
					<div class="col text-center">
						<h5 class="mb-0 mt-2 font-weight-bold text-danger">PLEASE NOTE:</h5>
						<?php 
						$max_length = 200;
						echo ( strlen($tr['tech_notes']) > $max_length)?substr($tr['tech_notes'],0,$max_length)." <a  id='more_tr_notes' href='javascript:void(0)'>[MORE]</a>":$tr['tech_notes'];
						?>
					</div>						
				</span>
