                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <p class="form-control-static">
                            ...
                            <input type="hidden" name="accommodation[street_number]" id="accommodation-street_number" />
                            <input type="hidden" name="accommodation[street_name]" id="accommodation-street_name" />
                            <input type="hidden" name="accommodation[suburb]" id="accommodation-suburb" />
                            <input type="hidden" name="accommodation[state]" id="accommodation-state" />
...
function initAutocomplete() {
    ...
    autocomplete.addListener("place_changed", () => {
        ...
        // street number
        var ac = jQuery("#address").val();
        var ac2 = ac.split(" ");
        var street_number = ac2[0];

        jQuery("#accommodation-street_number").val(street_number);

        // street name
        jQuery("#accommodation-street_name").val(street_name);
        
        // suburb
        jQuery("#accommodation-suburb").val(place.vicinity);

        // state
        jQuery("#accommodation-state").val(state);
