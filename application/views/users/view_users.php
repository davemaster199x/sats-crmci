...
?>
	...
	<section class="tabs-section">
							...
							<tbody>
								...
								<tr>
									...
									<td>
										...
										?>
                                        <?php if(!empty($v_sql)): ?>
                                        <a href="/vehicles/view_vehicle_details/<?php echo $v_sql['vehicles_id']; ?>" target="_blank"><?php echo $v_sql['number_plate']; ?></a>
                                        <?php endif; ?>
									</td>
									<td>
				...
				<div  style="margin-top:15px;">
					...
					?>
					<a href="<?php echo $display_user_url; ?>"><button type="button" class="btn"><?php echo $display_user_btn; ?></button></a>
					<a href="/users/add"><button type="button" class="btn btn-danger">Add User</button></a>
					<?php
					// only show to staff with 'Can edit permissions' permission
					if( $can_edit_permissions == true ){ ?>
						<a href="/users/assign_permissions"><button type="button" class="btn btn-info">Assign Permissions</button></a>
					<?php
					}
					?>					
				</div>
...
<div id="about_page_fb" class="fancybox" style="display:none;" >
	...
	<p>
	Displays all <span class="uppercase"><?= $this->config->item('theme') ?></span>  users
	</p>
</div>
<!-- Fancybox END -->
