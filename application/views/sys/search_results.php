                    ...
                    <div class="row">
                        ...
                        <div class="col-mdd-3">
                            <select id="search_type" name="search_type" class="form-control">
                                ...
                                <option value="8" <?php echo ( $this->input->get_post('search_type') == 8 ) ? 'selected="selected"' : null; ?>>Tenant Email</option>
                            </select>
...
<?php
    ...
    <?php
// phone and address
    if ($this->input->get_post('search_type') == 3 || $this->input->get_post('search_type') == 4 || $this->input->get_post('search_type') == 8 ) {
        ?>
                        ...
                        <thead>
                            <tr>
                                ...
                                for ($i = 1; $i <= $num_tenants; $i++) {
                                    ?>
                                    <th colspan="<?php echo $num_tenants; ?>">Tenant <?php echo $i ?></th>
                                    <?php
                                }
                                ?>			                            		
                            </tr>
...
//                                        }
                                        ...
                                        for ($pt_i = 0; $pt_i < $num_tenants; $pt_i++) {
                                            ...
                                            <td><?php echo $tenant_email[$pt_i]; ?></td>
                                            <?php
                                        }
                                        ?>		
                                    </tr>
