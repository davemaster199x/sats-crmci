                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control flatpickr flatpickr-input date-field editable-field" data-table="vehicles" data-field="warranty_expires" value="<?php echo ($this->system_model->isDateNotEmpty($vehicle->warranty_expires)) ? $this->system_model->formatDate($vehicle->warranty_expires,'d/m/Y') : null  ?>">
                            </div>
                        </div>
                    </div>
