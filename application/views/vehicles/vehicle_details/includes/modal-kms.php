                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?= ($this->system_model->isDateNotEmpty($kms->kms_updated)) ? $this->system_model->formatDate($kms->kms_updated, 'd/m/Y H:i:s') : 'No Data'; ?>" disabled>
                                    </div>
                                </div>
                            </div>
                        </fieldset>
