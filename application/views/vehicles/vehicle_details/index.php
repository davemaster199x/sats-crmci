<div class="box-typical box-typical-padding">
    <style>
        ...
        #tools_table_paginate > ul,
        #tools_table_paginate > ul > li{
                            ...
                            <div class="row">
                                <div class="col-md-3 col-xs-6">
                                    ...
                                    <a data-auto-focus="false" data-fancybox="" data-src="#fancybox-purchase-date" href="javascript:;">
                                        <?php echo ($this->system_model->isDateNotEmpty($vehicle->purchase_date) ? $this->system_model->formatDate($vehicle->purchase_date,'d/m/Y') : 'No Data'); ?>
                                    </a>
                                </div>
                                <div class="col-md-3 col-xs-6">
                                ...
                                <div class="col-md-3 col-xs-6">
                                    ...
                                    <a data-auto-focus="false" data-fancybox="" data-src="#fancybox-kms" href="javascript:;">
                                        ...
                                        <?php echo ($this->system_model->isDateNotEmpty($kms->kms_updated)) ? $this->system_model->formatDate($kms->kms_updated, 'd/m/Y H:i:s') : 'No Data'; ?> -
                            ...
                            <div class="row">
                                <div class="col-md-3 col-xs-6">
                                    ...
                                    <a data-auto-focus="false" data-fancybox="" data-src="#fancybox-warranty-expires" href="javascript:;">
                                        <?php echo ($this->system_model->isDateNotEmpty($vehicle->warranty_expires) ? $this->system_model->formatDate($vehicle->warranty_expires,'d/m/Y') : 'No Data'); ?>
                                    </a>
                                </div>
                                ...
                                <div class="col-md-3 col-xs-6">
                                    ...
                                    <a data-auto-focus="false" data-fancybox="" data-src="#fancybox-policy_expires" href="javascript:;">
                                        <?php echo ($this->system_model->isDateNotEmpty($vehicle->policy_expires) ? $this->system_model->formatDate($vehicle->policy_expires,'d/m/Y') : 'No Data'); ?>
                                    </a>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3 col-xs-6">
                                    ...
                                    <a data-auto-focus="false" data-fancybox="" data-src="#fancybox-rego_expires" href="javascript:;">
                                        <?php echo ($this->system_model->isDateNotEmpty($vehicle->rego_expires)) ? $this->system_model->formatDate($vehicle->rego_expires,'d/m/Y') : 'No Data'; ?>
                                    </a>
                                </div>
                                <div class="col-md-3 col-xs-6">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <section class="widget widget-reports">
                                                <header class="widget-header widget-header-blue">KMs Image</header>
                                                <div class="widget-content">
                                                    <div class="form-row pt-2 text-center justify-content-center">
                                                        <figure>
                                                            <?php 
                                                            if(!empty($kms->image_url)){
                                                                $kms_image = config_item('app_url'). "/images/kms_files/" .$kms->image_url;
                                                            }else{
                                                                $kms_image = config_item('app_url'). "/images/placeholder_no_image_available.png";
                                                            }
                                                            ?>
                                                            <img src="<?= $kms_image; ?>">
                                                        </figure>
...
<script>
    ...
    jQuery(document).ready(function() {
        ...
        jQuery("#btn_update_vehicle").click(function() {
            ...
            if (staff_id == "") {
                error += "<?=$this->config->item('company_name_short')?> user is required\n";
            }
