		        	...
		        	<div class="col-md-12 col-lg-5 columns">
				        ...
				        <div class="form-group row">
				         ...
				         <div class="form-group row">
				            ...
				            <div class="col-sm-9">
				                <p class="form-control-static"><input data-date-format="d/m/Y" type="text" class="flatpickrV2 form-control flatpickr-input" id="rego_expires" name="rego_expires" ></p>
				            </div>
						</div>
						...
						?>
				         ...
				         <div class="form-group row">
				            ...
				            <div class="col-sm-9">
				                <p class="form-control-static"><input data-date-format="d/m/Y" type="text" class="flatpickrV2 form-control flatpickr-input" id="warranty_expires" name="warranty_expires" ></p>
				            </div>
						</div>
				        ...
				        <div class="form-group row">
				            <label class="col-sm-3 form-control-label">Assign to <?=$this->config->item('company_name_short')?> User<span style="color:red">*</span></label>
				            <div class="col-sm-9">
				                <p class="form-control-static">
...
jQuery(document).ready(function(){
	...
	//init custom flatpicker
	jQuery(".flatpickrV2").flatpickr({
            allowInput: true
        });
