<div class="box-typical box-typical-padding">
	...
	$bc_items = array(
		...
		array(
			'title' => $title,
			'status' => 'active',
			'link' => "/properties/active_job_properties"
		)
	);
	...
	<header class="box-typical-header">
		...
		echo form_open('properties/active_job_properties',$form_attr);
		?>
					...
					<div class="row">
						...
						<div class="col-mdd-2">
							...
							<select id="state_filter" name="state_filter" class="form-control ">
								<option <?php echo ($this->input->get_post('state_filter')=="") ? 'selected' : NULL; ?> value="">ALL</option>
								<option <?php echo ($this->input->get_post('state_filter')==-1) ? 'selected' : NULL; ?> value="-1">NULL</option>
								<?php
						...
						<div class="col-md-2">
							<label for="phrase_select">Short Term Rental</label>
							<div class="checkbox">
								<input type="checkbox" id="holiday_rental" name="holiday_rental" <?php echo ( $this->input->get_post('holiday_rental') == 1 )?'checked':null; ?> value="1" />
						...
						<div class="col-md-2 columns">
							...
							<!--<button type="submit" class="btn btn-inline" name="btn_search" value="Search">Search</button>-->
				...
				<table class="table table-hover main-table">
					<thead>
						<tr>
							<th>Address</th>
							<th><?php
							 echo $this->gherxlib->getDynamicState($this->config->item('country'));
							?></th>
							<?php 				
							// get service type
							...
							?>							
								<th>
									<?=Alarm_job_type_model::icons($ajt->id);?>
								</th>							
							<?php
									}
					...
					<tbody>
						...
						<?php 
							...
							echo "<tr><td colspan='100%'>Please Filter Data</td></tr>";
						} 
						?>
					</tbody>
...
<div id="about_page_fb" class="fancybox" style="display:none;" >
	...
	<p>
		This page displays all properties that are active in the system and requires <?=config_item('company_name_short');?> to service them.
		<br/>This page does NOT include DIY, Other Supplier etc
