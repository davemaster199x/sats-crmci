                                        ...
                                        <?php if ($row->property_services):
                                            ...
                                            $services = array_unique(explode(",", $row->property_services));
                                                foreach($services as $service):   
                                                    if ($service):
                                        ?>
                                            <?=Alarm_job_type_model::icons($service);?>&nbsp;<span class="large-line">|</span>&nbsp;
                                        <?php       endif;
                                                endforeach;
                                              endif; 
                                        ?>
...
<div id="about_page_fb" class="fancybox" style="display:none;">
    ...
    <p>
        This page shows all properties where there is more than one service on <?=$this->config->item('company_name_short')?>.
    </p>
    <pre>
<code>
