                                   ...
                                   <!-- <div class="btn-group" data-toggle="buttons">-->
                                    <div class="btn-group form-group">
                                        <label class="btn" style="display: none;;">
                                            <input name="service<?php echo $index ?>" class="serv_sats css-checkbox serv_status<?php echo $index ?>" checked="checked" id="main1radio<?php echo $index ?>" value="1" type="radio"> <?=$this->config->item('company_name_short')?>
                                        </label>
