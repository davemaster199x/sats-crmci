                     ...
                     <style>
                        ...
                        <div style="display:none;">
                            ...
                            ?>
                                <label><?php 
                                if($row['id']==14){
                                    echo "Bundle Smoke Alarm, Corded Window, Safety Switch (Interconnected) ".$price_var_arr['price_breakdown_text'];
                                }else if($row['id']==13){
                                    echo "Smoke Alarm & Safety Switch (Interconnected) ".$price_var_arr['price_breakdown_text'];
                                }else if($row['id']==12){
                                    echo "Smoke Alarms (Interconnected) ".$price_var_arr['price_breakdown_text'];
                                }else if($row['id']==9){
                                    echo "Bundle Smoke Alarm, Corded Window, Safety Switch ".$price_var_arr['price_breakdown_text'];
                                }else{
                                    echo $row['type']." ".$price_var_arr['price_breakdown_text'];
                                }
                                ?></label>
                            </div>
                            <div class="col-md-9">
                                <div class="form-group services_chkbox_wrapper">
                                   <!-- <div class="btn-group" data-toggle="buttons">-->
                                    <div class="btn-group form-group">
                                        <label class="btn uppercase">
                                            <input name="service<?php echo $index ?>" class="serv_sats css-checkbox serv_status<?php echo $index ?>" id="main1radio<?php echo $index ?>" value="1" type="radio"> <?=$this->config->item('theme')?>
                                        </label>
                                        <label class="btn">
                                            <input name="service<?php echo $index ?>" class="serv_not_sats css-checkbox red-box serv_status<?php echo $index ?>" id="main1radio<?php echo $index ?>" value="0" type="radio"> DIY
                                        </label>
                                        <label class="btn active">
                                            <input name="service<?php echo $index ?>" class="serv_not_sats css-checkbox red-box serv_status<?php echo $index ?>" id="main1radio<?php echo $index ?>" checked="checked" value="2" type="radio"> No Response
                                        </label>
                                        <label class="btn">
                                            <input name="service<?php echo $index ?>" class="serv_not_sats css-checkbox red-box serv_status<?php echo $index ?>" id="main1radio<?php echo $index ?>" value="3" type="radio"> Other Provider
                                        </label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-control-wrapper form-control-icon-left">
                                                    <input type="text" name="price[]" class="price form-control" value="<?php echo $row['price']; ?>">
