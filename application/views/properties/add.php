...
<div class="box-typical box-typical-padding">
    ...
    <section class="box-typical steps-numeric-block col-lg-12s">
        ...
        <?php echo form_open_multipart('properties/add_property',array('id'=>'add_property_form')); ?>
       <div id="loader_block" style="display:none;"> <div id="div_loader"></div></div>
            ...
            <div class="ptabs" id="group_1" style="display:block;">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 available_api_div">
                        <header class="steps-numeric-title">Available API:</header>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group remember_agency_div">

                            <!-- <div class="checkbox-toggle">
                                <input type="checkbox" id="load_api_chk" />
                                <label for="load_api_chk">Load API</label>
                            </div> -->

                            <div class="checkbox-toggle load_api_div">
                                <input type="checkbox" id="remember_agency" class="remember_agency" name="remember_agency" value="1" />
                                <label for="remember_agency">Remember Agency</label>
                            </div>

                            <div class="checkbox-toggle">
                                <input type="checkbox" id="added_from_property_list" class="added_from_property_list" name="added_from_property_list" value="0" />
                                <label for="added_from_property_list">This property was added from a property list</label>
                            </div>

                            <div class="checkbox-toggle">
                                <input type="checkbox" id="source_of_company" class="source_of_company" name="source_of_company" value="0" />
                                <label for="source_of_company">Source of Company</label>
                            </div>

                            <div class="dropdown-agencies">
                                <input type="hidden" id="agency_from_other_company_property_val" name="agency_from_other_company_property_val" value="" />
                                <input type="hidden" id="source_of_company_toggle_val" name="source_of_company_toggle_val" value="" />
                                <label id="agency_from_other_company_property_list" name="agency_from_other_company_property_list" style="display:none"><label>
                            </div>

                        </div>
                    </div>

                    <div class="col-md-5 available_api_div" id="api_buttons_div">None</div>
            ...
            <div class="ptabs" id="group_4" style="display:none">
                ...
                <div class="hr_div">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-3"><label>Short Term Rental?</label></div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <select  data-field="Short Term Rental" name="holiday_rental" id="holiday_rental" class="form-control requiredV2">
                                            <option value="">Please select</option>
                    ...
                    <div class="row mb-2" id="service_garage_div">
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-3">
                                    <label>IF property has an attached garage that is NOT part of the tenancy please tick here</label>
                                </div>
                                <div class="col-md-3">
                                    <div class="checkbox">
                    ...
                    <div class="row current_vacant">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <select data-field="Property Currently Vacant" name="prop_vacant" id="prop_vacant" class="form-control">
                                                <option value="">Please select</option>
                                                <option value="0">No</option>
                                                <option value="1">Yes</option>
                                        </select>
                                ...
                                <div class="col-md-6">
                                        ...
                                        <div class="row vacant_from_to" style="display: none;">
                                            <div class="col-lg-6 col-md-6">
                                                <div class="form-group">
                                                    <div class="input-group" data-wrap="true" >
                                                        <!-- <input  data-input  type="text" class="form-control" name="vacant_from" id="datepicker_vacantF" placeholder="Vacant From" data-date-format="d-m-Y"> -->
                                                        <!-- <span class="input-group-append" data-toggle >
                                                                <span class="input-group-text"><i class="font-icon font-icon-calend"></i></span>
                                                        </span> -->
                                                        <input id="datepicker_vacantF" class="form-control" type="text" name="vacant_from" data-date-format="d/m/Y" />
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group" data-wrap="true">
                                                        <!-- <input   data-input  type="text" class="form-control" name="vacant_to" id="datepicker_vacantT" placeholder="Vacant To" data-date-format="d-m-Y">
                                                        <span class="input-group-append" data-toggle>
                                                                    <span class="input-group-text"><i class="font-icon font-icon-calend"></i></span>
                                                        </span> -->
                                                        <input id="datepicker_vacantT" class="form-control" type="text" name="vacant_to" data-date-format="d/m/Y" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                    ...
                    <div class="row new_tenancy" style="display: none;">
                        ...
                        <div class="col-md-5">
                            <div class="row new_tenant_start" style="display: none;">
                                <div class="col-md-9">
                                    <div class="form-group>">
                                        <div class="input-group date" data-wrap="true">
                ...
                <div>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="row">
                                <div class="col-md-8" id="landlord-form-label"><label>Landlord (optional)</label></div>
                            </div>
                        </div>
                        <div class="col-lg-9">
                            <div class="row">
                                <div class="col-lg-2">
                                    <div class="form-group ">
                                        ...
                                        <input type="hidden" class="form-control field_g2" name="agency-selected-text" id="agency-selected-text" value="">
                                    </div>
                                </div>
                                <div class="col-lg-3">
                                    <div class="form-group ">
                    ...
                    <div id="prop_upgraded_to_ic_sa_div" class="row">
                        <div class="col-lg-3">
                            <div class="row">
                                <div class="col-md-8"><label>Property upgraded to meet QLD 2022 Legislation</label></div>
                            </div>
                        </div>
                        <div class="col-lg-9">
                            <div class="row">
                                <div class="col-lg">
                                    <div class="checkbox">
                                        <input type="checkbox" id="prop_up_qld_leg_chk" name="prop_upgraded_to_ic_sa" value="1" />
                                        <label for="prop_up_qld_leg_chk"></label>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="dha_agencies_fields" style="display:none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2">
                                    <input name="start_date" class="form-control flatpickr-input" data-allow-input="true" type="text" placeholder="Start Date" >
                                </div>
                                <div class="col-lg-2">

                                    <input name="due_date" class="form-control flatpickr-input" data-allow-input="true" type="text" placeholder="End Date" >
                                </div>
                            </div>
                    </div>
             ...
             <div class="ptabs row" id="group_6" style="display:none;">
                    <div class="col-lg-12">
                            ...
                            <div class="row pm_div">
                                    <div class="col-lg-7">
                                        <header class="steps-numeric-title">Property Manager</header>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <p>&nbsp;</p>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <header class="steps-numeric-title">Other supplier Job</header>
                                            <div class="form-group">
                                                <select class="form-control" name="other_supplier_job" id="other_supplier_job">
                                                    <option value="1">Yes</option>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="other_supplier_job_date_box" style="display:none;">
                                                <div class="form-group">
                                                    <div class="input-group date" data-wrap="true" >
                                                        <!-- <input style="width:1%!important"  data-input  type="text" class="form-control" name="other_supplier_job_date" id="other_supplier_job_date" placeholder="Select Date" data-date-format="d/m/Y">
                                                        <span class="input-group-append" data-toggle >
                                                                <span class="input-group-text"><i class="font-icon font-icon-calend"></i></span>
                                                        </span> -->
                                                        <input id="other_supplier_job_date" class="form-control" type="text" name="other_supplier_job_date" data-date-format="d/m/Y" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div class="container-fluid prev_next_div">
            <div class="row">
                    ...
                    <div class="col">
                        <button type="button" onclick="nextPrev(1)" id="nextBtn"  class="btn btn_add_property_next">NEXT→</button>
                        ...
                        <input type="hidden" id="selected_pt_prop_id" name="selected_pt_prop_id" value=""/>
                        <input type="hidden" id="selected_ot_prop_id" name="selected_ot_prop_id" value=""/>
                        <input type="hidden" name="btnAddProperty" value="1" />
                        <button type="submit" id="btnAddProperty" class="btn btn-success">ADD PROPERTY</button>
...
<script type="text/javascript">
    ...
    // remember added_from_property_list
    function added_from_property_list(){

        var agency_id = jQuery("#agency").val();
        var added_from_property_list = ( jQuery("#added_from_property_list").prop("checked") == true )?agency_id:0;

        Cookies.set('added_from_property_list', added_from_property_list);
    }

    // remember source_of_company
    function source_of_company(){

        var agency_id = jQuery("#agency").val();
        var source_of_company = ( jQuery("#source_of_company").prop("checked") == true )?agency_id:0;

        Cookies.set('source_of_company', source_of_company);
    }
    ...
    jQuery('document').ready(function(){
        ...
        jQuery("#datepicker_vacantF, #datepicker_vacantT, #other_supplier_job_date ").flatpickr({
            allowInput: true
        });

        //on load/refresh get agency services if not null
        if( jQuery("#agency").val()!="" ){
            get_agency_services(jQuery("#agency").val());
        }
        ...
        // auto select "This property was added from a property list" script
        var added_from_property_list_id = parseInt(Cookies.get('added_from_property_list'));
        if(  added_from_property_list_id > 0  ){

            setTimeout(function(){

                jQuery("#added_from_property_list").prop("checked",true);
                jQuery("#agency").val(added_from_property_list_id).change();

            }, 1000);
            
        }

        // auto select "source_of_company" script
        var source_of_company_id = parseInt(Cookies.get('source_of_company'));
        if(  source_of_company_id > 0  ){

            setTimeout(function(){

                var source_toggle_val = jQuery("#source_of_company").prop("checked",true);
                jQuery("#agency").val(source_of_company_id).change();
                jQuery("#agency_from_other_company_property_list").css('display', 'block');
                jQuery("#source_of_company_toggle_val").val("1");
        ...
        jQuery(".api_main_div").on("click",".pme_prop_select_btn",function(){
            ...
            // property tree tenancy ID
            var pt_tenancy_id = container.find('.pt_tenancy_id').val();
            var pt_ownership_id = container.find('.pt_ownership_id').val();

            var street_arr = [];
            var msg = '';

            var key_dom = container.find('.pme_addr_key');
            var key = key_dom.val();
            var street = '';
            var agency_id = jQuery("#agency").val();
            ...
            function(isConfirm) {
                ...
                if (isConfirm) { // yes
                    ...
                    jQuery("#selected_pt_prop_id").val(""); // property tree clear
                    ...
                    if (parseInt(api_platform) == 3) { // property tree
                        jQuery("#selected_pt_prop_id").val(pme_prop_id);
                    }
                    ...
                    if ( parseInt(api_platform) == 3 && pt_tenancy_id != '' ) { // property tree

                        // load tenants
                        jQuery("#load-screen").show();
                        jQuery.ajax({
                            type: "POST",
                            url: "/property_tree/get_tenants_and_landlords",
                            dataType: "json",
                            data: {
                                pt_tenancy_id: pt_tenancy_id,
                                pt_ownership_id: pt_ownership_id,
                                agency_id: agency_id
                            }
                        }).done(function(ret){
                            ...
                            if( ret != '' ){
                                ...
                                if (typeof ret !== 'undefined') {
                                    ...
                                    // tenant
                                    var tenant_json = ret.tenant; 
                                    var has_tenants = false;
                                                                       
                                    if ( tenant_json.contacts.length > 0 ) {

                                        jQuery.each(tenant_json.contacts, function( index, contacts_row ) {		
   
                                            // ignore tenants that only has "emergency" as contact type
                                            if( !( contacts_row.contact_types.length == 1 && contacts_row.contact_types[0] == 'EmergencyContact' ) ){

                                                insertNewTenantRow(); // insert new row
                                            
                                                jQuery(".tenant_firstname:last").val(contacts_row.first_name);
                                                jQuery(".tenant_lastname:last").val(contacts_row.last_name);
                                                jQuery(".tenant_mobile:last").val(contacts_row.mobile_phone_number);
                                                jQuery(".tenant_ph:last").val(contacts_row.phone_number);
                                                jQuery(".tenant_email:last").val(contacts_row.email_address);
                                    ...
                                    // landlord
                                    var landlord_json = ret.landlord;                                    
                                    if ( landlord_json.contacts.length > 0 ) {

                                        jQuery("#landlord_firstname").val(landlord_json.contacts[0].first_name);
                                        jQuery("#landlord_lastname").val(landlord_json.contacts[0].last_name);
        ...
        jQuery('#prop_vacant').change(function(){
            ...
            if(thisVal == '1'){
                ...
                jQuery('#datepicker_vacantF').val('');
                jQuery('#datepicker_vacantT').val('');
            }
        })
        ...
        // added_from_property_list
        jQuery("#added_from_property_list").change(function(){
            added_from_property_list();
        });

        jQuery("#source_of_company").change(function(){
            source_of_company();
        });
        ...
        $('#agency').change(function(){
            ...
            var agentSelected = $('#agency').find('option:selected').text().trim()
            ...
            if( agency_id > 0 ){
                ...
                jQuery.ajax({
                    type: "POST",
                    url: "/properties/ajax_check_agency",
                    data: {
                        agency_id: agency_id,
                    }
                }).done(function(ret){

                    $('#agency-selected-text').val(ret)
                    if (ret === '1') {
                        $('#landlord-form-label').text('Landlord')
                        /*
                        $('#landlord_email').attr('placeholder','Email Address *')
                        $('#landlord_firstname').attr('placeholder','First Name*')
                        $('#landlord_lastname').attr('placeholder','Last Name *')
                        */
                ...
                //get_agency_from_other_company
                get_agency_from_other_company(agency_id);
                ...
                //Harris Key Number popup
                <?php if( $this->config->item('country') ==1 ){ ?>
                    if( agency_id == 1961 ){ //Adelaide
                        swal('warning','Please check the key number on the work Order before proceeding.\nKey Number 0 to 2999','warning');
                    }else if( agency_id==6203 ){ //Glenelg
                        swal('warning','Please check the key number on the work Order before proceeding.\nKey Number 3000 to 3999','warning');
                    }else if( agency_id==6974 ){ //Stirling
                        swal('warning','Please check the key number on the work Order before proceeding.\nKey Number 7000 to 7999','warning');
                    }
                <?php } ?>
        ...
        jQuery("#api_buttons_div").on("click",".api_buttons",function(){
            ...
            if (api_id == 1) {
                ...
                //alert(api_id);
                //return false;
                var api_url = "/properties/ajax_get_pt_properties";
            }
            jQuery.ajax({
                type: "POST",
                url: api_url,
        ...
        jQuery("#source_of_company").change(function(){
            if (jQuery(this).prop("checked")){
                ...
                jQuery(this).val("0");
                jQuery("#source_of_company_toggle_val").val("0");
                jQuery("#agency_from_other_company_property_list").css('display', 'none');
            }
        });
    ...
    function get_agency_services(agency_id){
        ...
        jQuery.ajax({
            type: "POST",
            url: "/property_ajax/property_mod/get_agency_services",
            data: {
                agency_id: agency_id
            }
        }).done(function(ret){
    ...
    function get_agency_from_other_company(agency_id)
    {
        jQuery.ajax({
            type: "POST",
            url: "<?php echo site_url(); ?>ajax/properties_ajax/ajax_get_agency_from_other_company",
            data: {
                agency_id: agency_id
            }
        }).done(function(res){
            var property_data = JSON.parse(res);
            var agency_html = "";
            
            // if (property_data.success == true) {
            //     console.log("ram agency");
                
            //     jQuery.each(property_data.data, function (key, value) {
            //         agency_html += '<option value="' + value.company_id + '">' + value.company_name + '</option>';
            //     });
            //     $("#agency_from_other_company_property_list").html(agency_html);
            // } else {
            //     agency_html = "<option>[ ---- ]</option>";
            //     $("#agency_from_other_company_property_list").html(agency_html);
            // }

            if (property_data.success == true) {
                $("#agency_from_other_company_property_list").html(property_data.data[0].company_name);
                $("#agency_from_other_company_property_val").val(property_data.data[0].company_id);
                // console.log(property_data.data[0].company_name);
            } else {
                $("#agency_from_other_company_property_list").html("[Blank]");
                $("#agency_from_other_company_property_val").val(0);
            }
        });
        ...
        if( fullAdd_cleared != '' ){
            ...
            jQuery.ajax({
                ...
                success: function(data){
                    ...
                    jQuery("#load-screen").hide();
                    var crmci_link = "<?php echo $this->config->item('crmci_link') ?>/properties/details/?id="+data.property_id;
                    var agency_txt = '';
                    ...
                    if(data.match == 1){ // duplicate found
                        ...
                        jQuery("#duplicate_prop_msg").html('<a href="javascript:void(0);" class="txt_red"><span class="fa fa-exclamation-triangle"></span></a> This property already exists with '+agency_txt+'. <a target="_blank" href="'+crmci_link+'" class="txt_red">View Property Here</a>');
    ...
    function nextPrev(n) {
        ...
        if( state == 'QLD' ){
            jQuery("#prop_upgraded_to_ic_sa_div").css('display','flex');
        }
        ...
        var isComplete = true
        if( currentTab == 4 && $('#agency-selected-text').val() === '1'){ // if step 4, check the required fields

            if ($('#landlord_email').val() === '') {
                $('#landlord_email').parent().append('<div class="form-tooltip-error" data-error-list=""><ul><li>Email Address must not be empty.</li></ul></div>')
                $('#landlord_email').addClass('error')
                isComplete = false
            }

            if ($('#landlord_firstname').val() === '') {
                $('#landlord_firstname').parent().append('<div class="form-tooltip-error" data-error-list=""><ul><li>First Name must not be empty.</li></ul></div>')
                $('#landlord_firstname').addClass('error')
                isComplete = false
            }

            if ($('#landlord_lastname').val() === '') {
                $('#landlord_lastname').parent().append('<div class="form-tooltip-error" data-error-list=""><ul><li>Last Name must not be empty.</li></ul></div>')
                $('#landlord_lastname').addClass('error')
                isComplete = false
            }

            /*
            if ($('#landlord_mobile').val() === '') {
                $('#landlord_mobile').parent().append('<div class="form-tooltip-error" data-error-list=""><ul><li>Mobile must not be empty.</li></ul></div>')
                $('#landlord_mobile').addClass('error')
                isComplete = false
            }
            if ($('#landlord_landline').val() === '') {
                $('#landlord_landline').parent().append('<div class="form-tooltip-error" data-error-list=""><ul><li>Phone must not be empty.</li></ul></div>')
                $('#landlord_landline').addClass('error')
                isComplete = false
            }
            */
              
        if (!isComplete) currentTab = 3
        } else {
            $('.form-tooltip-error').remove()
            $('#landlord_email').removeClass('error')
            $('#landlord_firstname').removeClass('error')
            $('#landlord_lastname').removeClass('error')
            
            $('#landlord_mobile').removeClass('error')
            $('#landlord_landline').removeClass('error')
