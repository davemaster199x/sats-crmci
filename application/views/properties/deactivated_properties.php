				...
				<div class="col-md-10 columns">
					...
					<div class="col-md-2">
						...
						<div class="col-md-2">
							...
							<select name="salesrep"  class="form-control field_g2 select2-photo">
								<option value="">All</option>
								<?php foreach($sales_rep_filter->result_array() as $sales_rep_row): ?>
								<option value="<?php echo $sales_rep_row['StaffID']; ?>" <?php echo ( $sales_rep_row['StaffID']==$this->input->get_post('salesrep')
									)?'selected="selected"':''; ?>>
									<?php echo "{$sales_rep_row['salesrep_fname']} {$sales_rep_row['salesrep_lname']}"; ?>
								</option>
								<?php endforeach ?>
							</select>
						</div>
				...
				<table class="table table-hover main-table">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								<?php echo "{$list_item['salesrep_fname']} {$list_item['salesrep_lname']}"; ?>
							</td>
							<td>
								<?php echo $list_item['p_reason']; ?>
							</td>
							<td>
								<?php  echo ($list_item['a_deleted']==1)?"Agency":$this->config->item('company_name_short'); ?>
							</td>							
...
<div id="about_page_fb" class="fancybox" style="display:none;" >
	...
	<p>This page shows all properties that are deactivated in our system. They have been NLM'ed for various reasons.</p>
