                            ...
                            <tr class="body_tr jalign_left">
                                <td>
                                    <span><?Php echo $this->gherxlib->crmLink('vpd', $row['property_id'], $row['property_id']); ?>
                                        <!--<a href="/properties/details/?id=<?php echo $row['property_id']; ?>"><?php echo $row['property_id']; ?></a>-->
                                    </span>
                                ...
                                <td>
                                    <span>
                                        ...
                                        <a href="/properties/details/?id=<?php echo $row['property_id']; ?>"><?php echo "{$row['address_1']} {$row['address_2']} {$row['address_3']} {$row['state']}"; ?></a>
                                    </span>
                                </td>
                                <td>
