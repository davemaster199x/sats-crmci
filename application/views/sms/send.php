                ...
                if( $job_id > 0 ){ ?>
                    ...
                    <div class="form-group row">  
                        ...
                        <!--<button type="button" class="btn tag_btn" data-tag_val="{your_agency}">Your agency</button>-->
                            ...
                            <button type="button" class="btn tag_btn" data-tag_val="{sats_google_review}"><?=$this->config->item('company_name_short')?> Google Review</button>
                        </div>
