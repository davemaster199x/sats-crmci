	...
	<div class="form-group row">
		...
		<div class="col-sm-3">
			...
			<div class="form-group row tags_div">
				...
				<button type="button" class="btn tag_btn" data-tag_val="{tenant_number}"><?=$this->config->item('company_name_short')?> Tenant Line</button>
			<!--<button type="button" class="btn tag_btn" data-tag_val="{your_agency}">Your agency</button>-->
                ...
                <button type="button" class="btn tag_btn" data-tag_val="{sats_domain}"><?=$this->config->item('company_name_short')?> Domain</button>
	...
	<div class="form-group row">
		...
		<div class="col-sm-9">
			...
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<p class="form-control-static">
						<textarea name="body" id="sms_body" rows="4" class="form-control body" data-validation="[NOTEMPTY]"></textarea>
					</p>
				</div>
			</div>

			<div class="form-group row">
				<label class="col-sm-2 form-control-label">Character Count</label>
				<div class="col-sm-10">
					<p class="form-control-static text-success" id="character_count">0</p>
				</div>
			</div>
...
jQuery(document).ready(function(){
	...
	jQuery("#sms_body").keyup(function(){

		var sms_body_count = jQuery("#sms_body").val().length;
		var character_count = jQuery("#character_count");

		character_count.html(sms_body_count);

		if( sms_body_count > 160 ){

			character_count.removeClass("text-success");
