                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if($cr['type_name'] == "Sales upgrade"){ ?>
                                        <a href="mailto:<?php echo make_email('salesupgrades'); ?>?Subject=Sales Upgrade SMS Response&body=<?php echo $cr['response']; ?>"><button type="button" class="submitbtnImg blue-btn btn">Email</button></a>
                                    <?php } 
                                      }
                                    ?>                                    
                                </td>
...
function process_sms_replies(obj){
    ...
    jQuery.ajax({
        ...
        if( obj.hasClass("insert_n_open_job_link") == true ){
            var url = "<?php echo $this->config->item("crmci_link"); ?>/jobs/details/"+job_id;        
