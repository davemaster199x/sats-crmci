...
?>
	<div class="text-center">
		...
		<img src="<?= theme('/images/logo_login.png'); ?>" class="logo" />
	</div>
	...
	<div style="display: block;">
		...
		<?php 
		// user doesnt exist
		if( $this->session->flashdata('prohib_using_web_crm') == 1 ){ ?>
			<div class="alert alert-danger">
			Access to the Tech Portal has been restricted. Please use your Mobile App instead.
			</div>
		<?php
		}	
		?>
