                    ...
                    <section class="card card-blue-fill not_included">
                        ...
                        <div class="card-block">
                            ...
                            <div class="text-center form-group">
                                <button type="button" class="btn btn-primary-outline btn_insert_sa_alarms btn_autofill_alarms" onclick="insert_or_clear_qld_or_sa_alarms(this,this.value, 'add')" value="2">Insert SA Alarms</button>
                                <button type="button" class="btn btn-primary-outline btn_insert_qld_alarms btn_autofill_alarms" onclick="insert_or_clear_qld_or_sa_alarms(this, this.value, 'add')" value="1">Insert QLD Alarms</button>
                            </div>
                            <?php endif; ?>
...
<?php if(config_item('theme') == 'sas'): ?>
    <script src="<?= base_url('/inc/js/sas_auto_fill_alarm.js') ?>"></script>
<?php endif; ?>
...
<script type="text/javascript">
    ...
    jQuery('document').ready(function(){
        ...
        jQuery("#agen_stat").change(function(){
        ...
        jQuery("#add_agency").click(function(){
            ...
            if(agen_stat=='active'){
                ...
                // alarm price
                // dont validate alarm price 0 in SAS | allow 0 price for sas only
