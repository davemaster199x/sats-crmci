        ...
        <div class="row">
            ...
            <div class="col-md-6 columns text-left">
                ...
                <div class="row form-group">                   
                    ...
                    <div class="col-md-6 column tt_boxes">
                        <label>Subscription Billed</label>
                        <?php echo ( $row['allow_upfront_billing'] == 1 )?'Yes':'<span class="text-danger">No</span>'; ?>
                    </div>
                ...
                <div id="fancybox_agency_api_sec" style="display:none; min-width: 700px;">
                    <section class="card card-blue-fill">
                        <header class="card-header">Trust Account Software & API's</header>
                        <div class="card-block">                            
                            ...
                            <table class="table table-borderless">
                                <tr>
                                    ...
                                    <td>
                                        <a data-auto-focus="false" data-fancybox data-src="#fancybox_agency_trus_account_software_sec" href="javascript:void(0);">
                                            <?php echo ( $row['tsa_name'] !='' )?$row['tsa_name']:'No Data'; ?>
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <?php 
                                        if( $connectedAPI['connected_service'] == 3 ){ // propertytree            
                                            
                                            $pt_connection_txt  = ( $connectedAPI['agency_api_token_id'] > 0 && $pt_has_preference == true )?'Full':'Partial';
                                            $api_name = "{$connectedAPI['api_name']} ({$pt_connection_txt})";

                                        }else { // other API
                                            $api_name = $connectedAPI['api_name'];
                                        }
                                        echo $api_name; 
                                        ?>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php                                                     
                                            if( $connectedAPI['agency_api_id'] == 5 ){ // console cloud, using webhooks
                                                ...
                                                echo ( $connectedAPI['agency_api_token_id'] > 0 )?'<span class="text-green">Yes</span>':'<span style="color:red;">No</span>';
                                ...
                                <tr>
                                    ...
                                    <td><?= date("d/m/Y H:i",strtotime($connectedAPI['token_connection_date'])) ?></td>
                                </tr>                                
                                <tr>
                                    <th>Trust Account Agency ID</th>
                                    <td>
                                        <a data-auto-focus="false" data-fancybox data-src="#fancybox_agency_trus_account_software_sec" href="javascript:void(0);">
                                            <?php echo ( $row['propertyme_agency_id'] !='' )?$row['propertyme_agency_id']:'No Data'; ?>
                                        </a>
                                    </td>
                                </tr>
                                <tr>
                                    <th>Invoice Delivery</th>
                                    <td><?php echo ( $connectedAPI['is_invoice'] == 1 )?'API':'Email'; ?></td>
                                </tr>
                                <tr>
                                    <th>Certificate Delivery</th>
                                    <td><?php echo ( $connectedAPI['is_certificate'] == 1 )?'API':'Email'; ?></td>
                                </tr>
                                <?php    
                                if( $connectedAPI['connected_service'] == 3 ){ // property tree
                                ?>
                                        ...
                                        <td colspan="100">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        if( $ret_obj->httpcode == 200 ){
                                                            ...
                                                            foreach( $ret_obj->json_decoded_response as $creditor_row ){
                                                                ...
                                                                if( $creditor_row->creditor_id == $pt_agen_pref_row->creditor ){
                                                    ...
                                                    <td><?php echo $pt_agen_pref_row->creditor; ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Account</th>
                                                    <td>
                                                        ...
                                                        if( $ret_obj->httpcode == 200 ){
                                                            ...
                                                            foreach( $ret_obj->json_decoded_response as $account_row ){
                                                                ...
                                                                if( $account_row->id == $pt_agen_pref_row->account ){
                                                    ...
                                                    <td><?php echo $pt_agen_pref_row->account; ?></td>
                                                </tr>
                                                <tr>
                                                    <th>Property Compliance Category</th>
                                                    <td>
                                                        <?php
                                                        ...
                                                        if( $ret_obj->httpcode == 200 ){
                                                            ...
                                                            foreach( $ret_obj->json_decoded_response as $comp_cat_row ){
                                                                ...
                                                                if( $comp_cat_row->category_id == $pt_agen_pref_row->prop_comp_cat ){
                                                    ...
                                                    <td><?php echo $pt_agen_pref_row->prop_comp_cat; ?></td>
                                                </tr>
                                            </table>
                                        </td>
                                    </tr> 
                                ...
                                <?php
                                }else if( $connectedAPI['connected_service'] == 4 ){ // Palace

                                    $supplier_id = ( $row['palace_supplier_id'] != '' )?$row['palace_supplier_id']:"<span class='text-danger'>To send Invoices/Certificates via API you must connect Supplier <a href='/palace/supplier_palace'>HERE</a></span>";
                                    $agent_id = ( $row['palace_agent_id'] != '' )?$row['palace_agent_id']:"<span class='text-danger'>To send Invoices/Certificates via API you must connect Agent <a href='/palace/agent_palace'>HERE</a></span>";
                                    $diary_id = ( $row['palace_diary_id'] != '' )?$row['palace_diary_id']:"<span class='text-danger'>To send Invoices/Certificates via API you must connect Diary Group <a href='/palace/diary_palace'>HERE</a></span>";
                                        ...
                                        <td colspan="100">
                                            <table class="table">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        $supplier_json = $this->palace_model->get_palace_supplier_by_id($agency_id, $row['palace_supplier_id']);
                                                        echo $supplier_json[0]->SupplierCompanyName;
                                                        ?>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        $agent_json = $this->palace_model->get_palace_agent_by_id($agency_id, $row['palace_agent_id']);
                                                        echo $agent_json[0]->AgentFullName;
                                                        ?>
                                                    </td>
                                ...
                                <?php
                                }else if( $connectedAPI['connected_service'] == 1 ){ // PMe
                                    $supplier_id = ( $row['pme_supplier_id'] != '' )?$row['pme_supplier_id']:"<span class='text-danger'>To send Invoices/Certificates via API you must connect Supplier <a href='/property_me/supplier_pme'>HERE</a></span>";
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            echo $contact_json->Contact->Reference; // marker name
                                            ?>    
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="vad_cta_box">
                                <div class="row">
                                    <div class="col-md-4"> 
                                        <button class="btn btn-danger w-100 text-nowrap" id="btn_unlink_disable">
                                        Unlink & Delete
                                        </button>
                                    </div>
                                    ...
                                    ?>
                                            <button id="btn_unlink_connected_api_prop" class="btn btn-danger w-100 text-nowrap">Unlink All Properties</button>
                                    <?php
                                        }
                                    ?>
                                    </div>
                                    <div class="col-md-4"> 
                                        ...
                                        <!-- this button can only be treggered by developers -->
                                        <a data-api_token_id="<?php echo $connectedAPI['agency_api_token_id']; ?>" 
                                            data-agency_id="<?php echo $agency_id; ?>" 
                                            data-api_integration_id="<?php echo $connectedAPI['api_integration_id'] ?>" 
                                            data-api_id="<?php echo $connectedAPI['connected_service'] ?>" 
                                            data-toggle="tooltip" title="" 
                                            class="<?= ( $connectedAPI['agency_api_token_id'] > 0 ) ? 'remove_agency_token_btn' : 'btn_delete' ?> action_a btn btn-danger w-100 text-nowrap" 
                                            data-original-title="<?php echo ( $connectedAPI['agency_api_token_id'] > 0 ) ? 'Remove API Token' : 'Remove API' ?>"
                                        >
                                            Disable Integration
                                        </a>
                                    </div>
                        ...
                        <section class="card card-red-fill">
                            ...
                            <div class="card-block">
                                <div class="row">
                                    <div class="col-md-6 columns">
                                        <div class="form-group">
                                            <label class="form-label">Active Properties with <?=$this->config->item('company_name_short')?></label>
                            ...
                            <div class="form-group">
                                <select id="franchise_group" name="franchise_group" class="form-control" title="Franchise Group">
                                    ...
                                    foreach($fg_sql->result_array() as $fg){ ?>
                                        <option value="<?php echo $fg['franchise_groups_id'] ?>" <?php echo ($row['franchise_groups_id']==$fg['franchise_groups_id'])?'selected="selected"':''; ?> <?php echo $fg['franchise_groups_id'] == 10 && $fg_users_disable != 2? "disabled" : "" ?> ><?php echo $fg['name']; ?></option>
                                    <?php
                                    }
                                    ?>
                                </select>	
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 columns">
                            ...
                            <div class="row form-group">
                                <div class="col-md-12 columns">
                                    <div class="left tt_boxes text-left">
                                        <label>Trust Account Software & API's</label>         
                                        <?php
                                            if(count($api) > 0){
                                            $api_name_arr = [];
                            ...
                            <div class="row form-group">
                                <div class="col-md-12 columns">
                                    <div class="left tt_boxes text-left">
                                        <label>Source of Client <a id="add_source_of_client_fb_link" href="javascript:void">+</a></label>
                            ...
                            <div id="fancybox_from_other_company" style="display:none;">
                                ...
                                <section class="card card-blue-fill">
                                    <header class="card-header">Source of Client</header>
                                    <div class="card-block">           
                                        <div class="form-group row">
                            ...
                            <div id="add_source_of_client_fb" style="display:none;">
                                ...
                                <section class="card card-blue-fill">
                                    ...
                                    <div class="card-block">
                                        <table class="table table-hover main-table">
                                            ...
                                            <tbody>
                                                <?php foreach( $sa_comp_sql->result() as $sa_comp_row ): ?>
                                                    <tr>
                                                        <td>
                                                            <span class="company_name_lbl"><?php echo $sa_comp_row->company_name ?></span>
                                                            <input type="text" class=" form-control company_name_hid" value="<?php echo $sa_comp_row->company_name ?>" />
                                                        </td>
                                                        <td>
                                                            <button class="btn btn-warning edit_source_of_client_btn">Edit</button>
                                                            <input type="hidden" class="sac_id" value="<?php echo $sa_comp_row->sac_id; ?>">

                                                            <button class="btn btn-success update_source_of_client_btn">Update</button>
                                                            <button class="btn btn-secondary cancel_source_of_client_btn">Cancel</button>

                                                            <button class="btn btn-danger delete_source_of_client_btn">Delete</button>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; ?>
                                                <tr>
                                                    <td><input type="text" class="form-control" id="soc_company_name" placeholder="New Company" /></td>
                                                    <td> <button class="btn" id="add_source_of_client_btn">Add</button></td>
                                                </tr>                                          
                                            </tbody>
                                        </table>
                                    </div>
                            ...
                            <div id="update_source_of_client_confirm_fb" style="display:none;">

                                <h5>Would you also like to set all properties associated with this agency to the same source?</h5>

                                <div class="text-center">
                                    <button type="button" class="btn btn-success" id="yes_all_prop_as_well_btn">Yes, All Properties As Well</button>
                                    <button type="button" class="btn btn-primary" id="no_agency_only_btn">No, This Agency Only</button>
                                    <button type="button" class="btn btn-danger" id="cancel_update_source_btn">Cancel</button>
                                </div>
                    ...
                    <div class="col-md-6 columns">
                        ...
                        <div class="row form-group">
                            <div class="col-md-12 columns">
                                <div class="left tt_boxes text-left">
                                    <label>Joined <?= $this->config->item('company_name_short') ?></label>
                                ...
                                <div id="fancybox_joined_sats" style="display:none;">
                                    <section class="card card-blue-fill">
                                        <header class="card-header">Joined <?=$this->config->item('company_name_short')?></header>
                                        <div class="card-block">
                                            <div class="form-group">   
                                                <input id="joined_sats" class="form-control flatpickr flatpickr-input" title="Joined <?=$this->config->item('company_name_short')?>" type="text" name="joined_sats" value="<?php echo ( $row['joined_sats']!='' )?date('d/m/Y',strtotime($row['joined_sats'])):''; ?>" />
...
.company_name_hid,
.update_source_of_client_btn,
.cancel_source_of_client_btn{
    display: none;
}
.pt_settings_heading{
    color: #00607f;
...
<script>
    ...
    function update_source_of_client(yes_including_prop){
        ...
        jQuery.ajax({
            ...
            dataType: 'json',
            data: {
                'type': 'from_other_company_btn_update',
                'agency_id': <?php echo $agency_id; ?>,
                'from_other_company': from_other_company,
                'yes_including_prop': yes_including_prop
            }
    ...
    jQuery(document).ready(function(){
        ...
        $('.btn_update').on('click',function(e){
            ...
            if(agency_status == "deactivated"){
                if(active_prop_with_sats==""){
                    error += "Active Properties with <?=$this->config->item('company_name_short')?> is required\n";
                }
            }
        ...
        $('.btn-activate').on('click',function(){
            ...
            var agency_phone = jQuery("#phone").val();
            var agency_emails = jQuery("#agency_emails").val();
            var agency_acc_emails = jQuery("#account_emails").val();
            var error = '';
            ...
            if( agency_phone == ''   ){
                error += "Office Landline is required\n";
            }
            ...
            if( agency_acc_emails == ''   ){
                error += "Agency Account Email is required\n";
            }
        ...
        $('#btn_update_additional_details').on('click',function(e){
            ...
            if( $row['status']=='active' ){ ?>
                ...
                let agency_email_str_arr = jQuery('#agency_emails').val().split('\n');
                if( jQuery.inArray("", agency_email_str_arr) !== -1 ){
                    error += "Agency emails invalid input\n";
                }

                //agency email validate email format
                if (!validateEmails(agency_email_str_arr)) {
                    error += "Agency emails invalid format\n";
                }

                //agency accounts validaate white space per line
                let account_emails_str_arr = jQuery('#account_emails').val().split('\n');
                if( jQuery.inArray("", account_emails_str_arr) !== -1 ){
                    error += "Account emails invalid input\n";
                }

                //agency accounts validate email format
                if (!validateEmails(account_emails_str_arr)) {
                    error += "Account emails have invalid format\n";
                }
        ...
        // unlink and disable api
        jQuery("#btn_unlink_disable").click(function(){
            var remove_token = <?= $connectedAPI['agency_api_token_id'] > 0 ? 1 : 0 ?>          
                       
            swal(
                {
                    title: "",
                    text: "This will unlink ALL property and delete API integration and token as well. Do you want to continue?",
                    type: "warning",
                    showCancelButton: true,
                    confirmButtonClass: "btn-success",
                    confirmButtonText: "Yes",
                ...
                function(isConfirm){
                    if(isConfirm){
                        ...
                        swal.close();
                                jQuery.ajax({
                                type: "POST",
                                url: "<?php echo base_url('/agency/ajax_unlink_disable_connected_api') ?>",
                                dataType: 'json',
                                data: {
                                    agency_id: <?= $agency_id ?? 0; ?>,
                                    api_integration_id: <?= $connectedAPI['api_integration_id'] ?? 0?>,
                                    api_id: <?= $connectedAPI['connected_service'] ?? 0 ?>,
                                    del_api_integ: 1,
                                    remove_token
                                }
                                }).done(function(data){
                                    ...
                                    if(data.status){
                                        ...
                                        swal({
                                            title:"Success!",
                                            text: "Connected PropertyMe Properties has been unlinked and disabled",
                                            type: "success",
                                            showConfirmButton: <?php echo $this->config->item('showConfirmButton') ?>,
                                            timer: <?php echo $this->config->item('timer') ?>
                                        });
        ...
        $('#from_other_company_btn_update').on('click',function(){           
            ...
            // launch fancybox
            $.fancybox.open({
                src  : '#update_source_of_client_confirm_fb'
            });       

        });

        // yes
        jQuery("#yes_all_prop_as_well_btn").click(function(){

            update_source_of_client(1);

        });


        // no
        jQuery("#no_agency_only_btn").click(function(){

            update_source_of_client(0);

        });


        // cancel
        jQuery("#cancel_update_source_btn").click(function(){
        ...
        jQuery("#add_source_of_client_fb_link").click(function(){

            // launch fancybox
            $.fancybox.open({
                src  : '#add_source_of_client_fb'
            });
        ...
        // add company script
        jQuery("#add_source_of_client_btn").click(function(){

            var soc_company_name = jQuery("#soc_company_name").val();
            var error = '';
            ...
            if( error != '' ){ // has error
                ...
                jQuery.ajax({
                    type: "POST",
                    url: "/agency/add_source_of_client",
                    data: {
                        soc_company_name: soc_company_name
                    }
                }).done(function() {	
                    ...
                    swal({
                        title:"Success!",
                        text: "New Source of Client Added!",
                        type: "success",
                        showCancelButton: false,
                        confirmButtonText: "OK",
                        closeOnConfirm: false,  
        ...
        jQuery(".edit_source_of_client_btn, .cancel_source_of_client_btn").click(function(){

            var edit_btn_dom = jQuery(this);
            var parent_tr = edit_btn_dom.parents("tr:first");

            // toggle company field
            parent_tr.find(".company_name_lbl").toggle();
            parent_tr.find(".company_name_hid").toggle();

            // toggle edit, save and cancel button
            parent_tr.find(".edit_source_of_client_btn").toggle();
            parent_tr.find(".update_source_of_client_btn").toggle();
            parent_tr.find(".cancel_source_of_client_btn").toggle();

        });

        // update source of client
        jQuery(".update_source_of_client_btn").click(function(){

            var update_btn_dom = jQuery(this);
            var parent_tr = update_btn_dom.parents("tr:first");
            var soc_company_name = parent_tr.find(".company_name_hid").val();
            var sac_id = parent_tr.find(".sac_id").val();

            $('#load-screen').show();
            jQuery.ajax({
                type: "POST",
                url: "/agency/update_source_of_client",
                data: {
                    sac_id: sac_id,
                    soc_company_name: soc_company_name
                }
        ...
        // update source of client
        jQuery(".delete_source_of_client_btn").click(function(){

            var delete_btn_dom = jQuery(this);
            var parent_tr = delete_btn_dom.parents("tr:first");
            var sac_id = parent_tr.find(".sac_id").val();
            ...
            if( sac_id > 0 ){
                ...
                swal({
                    title: "Warning!",
                    text: "This will delete this source client. Do you want to continue?",
                    type: "warning",						
                    showCancelButton: true,
                    confirmButtonClass: "btn-success",
                ...
                function(isConfirm) {
                    ...
                    if (isConfirm) {							  
                        ...
                        jQuery.ajax({
                            type: "POST",
                            url: "/agency/delete_source_of_client",
                            data: {
                                sac_id: sac_id
                            }
                        }).done(function() {	
        ...
        /****
         * Ajax agency_api_documents for Invoice
         *  ****/
        // jQuery("#invoices_docs").on("change", function() {
        //     var node = jQuery(this);
        //     var invoices_check = ( node.prop("checked") == true ) ? 1 : 0;
        //     jQuery(this).val(invoices_check);

        //     var invoices_val = node.val();

        //     // var certificates_val = jQuery('#certificates_docs').val();

        //     var certificates_val = node.closest(".document_to_send").find('#certificates_docs').val();

        //     jQuery('#load-screen').show();

        //     jQuery.ajax({
        //         type: "POST",
        //         url: "<?php echo site_url(); ?>ajax/agency_ajax/ajax_agency_api_documents",
        //         dataType: 'json',
        //         data: {
        //             agency_id: <?php echo $agency_id; ?>,
        //             is_invoice: invoices_val,
        //             is_certificate: certificates_val,
        //             field: 'Invoice'
        //         }
        //     }).done(function(response) {
        ...
        //         swal({
        //             title: "Success!",
        //             text: "API Push Preference Success",
        //             type: "success",
        //             confirmButtonClass: "btn-success",
        //             showConfirmButton: <?php echo $this->config->item('showConfirmButton') ?>,
        //             timer: <?php echo $this->config->item('timer') ?>
        ...
        //  /****
        //  * Ajax agency_api_documents for Certificates
        //  *  ****/
        // jQuery("#certificates_docs").on("change", function() {
        //     var node = jQuery(this);
        //     var certificates_check = ( node.prop("checked") == true ) ? 1 : 0;
        //     jQuery(this).val(certificates_check);

        //     var certificates_val = node.val();
        //     // var invoices_val = jQuery('#invoices_docs').val();
        //     var invoices_val = node.closest(".document_to_send").find('#invoices_docs').val();
    ...
    /**
     * Validate Emails (Agency and Account)
    ...
    const validateEmails = (emails) => {
        ...
        return emails.every(item => regex.test(item));
    };
</script>