            ...
            <tbody>
                <?php foreach($agency_pm_sql as $pm){ ?>
                    <tr>
                        ...
                        <td>
                            <div class="float-left"><?php echo $pm['phone']; ?></div>
                            <?php
                            // phone 2FA
                            if( $pm['phone'] != '' && ( $pm['au_2fa_type'] == 1 && $pm['au_2fa_send_to'] != '' ) ){

                                // trim and remove space
                                $user_phone_no_space = str_replace(' ', '', trim($pm['phone']));
                                $user_2fa_phone_no_space = str_replace(' ', '', trim($pm['au_2fa_send_to']));

                                // show 2fa icon
                                if( $pm['au_2fa_type'] == 1 && $user_phone_no_space == $user_2fa_phone_no_space ){ ?>
                                    <div class="float-left ml-2">
                                        <a href="javascript:void(0);">
                                            <span class="fa fa-shield user_2fa_icon" data-toggle="tooltip" title="2 Factor Authentication(2FA)"></span>
                                        </a>
                                    </div>
                                <?php
                                }
                        ...
                        <td>                        
                            <div class="float-left"><?php echo $pm['email']; ?></div>
                            <?php
                            // email 2FA
                            if( $pm['email'] != '' && ( $pm['au_2fa_type'] == 2 && $pm['au_2fa_send_to'] != '' ) ){

                                // trim and remove space
                                $user_email_no_space = str_replace(' ', '', trim($pm['email']));
                                $user_2fa_email_no_space = str_replace(' ', '', trim($pm['au_2fa_send_to']));

                                // show 2fa icon
                                if( $pm['au_2fa_type'] == 2 && $user_email_no_space == $user_2fa_email_no_space ){ ?>
                                    <div class="fa fa-shield float-left ml-2" data-toggle="tooltip" title="2 Factor Authentication(2FA)"></div>
                                <?php
                                }
                        ...
                        <td>
                            ...
                            if( $pm['active'] == 1 ){
                                if( $pm['password'] != '' ){ ?>
                                    <a href="<?php echo $this->config->item('agency_link'); ?>?user=<?php echo $pm['email']; ?>&agency_id=<?php echo $agency_id; ?>&pass=<?php echo $pm['password'] ?>&crm_login=1" target="__blank">
                        ...
                        <td>
                            ...
                            if( $pm['active'] == 1 ){
                                if(  $pm['password'] == '' ){ ?>
                                    <a class="invite_email_link" href="<?php echo $this->config->item('agency_link'); ?>/sys/send_invite_email?aua_id=<?php echo $pm['agency_user_account_id']; ?>" target="__blank">
                        ...
                        <td>
                            ...
                            // reset password
                            if( $pm['active'] == 1 ){ ?>
                                <a class="reset_pass_email_link" href="<?php echo $this->config->item('agency_link'); ?>/sys/send_reset_password_email?aua_id=<?php echo $pm['agency_user_account_id']; ?>" target="__blank">
                                    <span class="fa fa-envelope-o"></span>
                                </a>	
                            <?php
                            }
