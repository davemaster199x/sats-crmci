<div role="tabpanel" class="tab-pane fade <?php echo ($this->input->get('prop_type')=='3')?'active show':'' ?>" id="vad_prop_tab_3">
						...
						<div class="table-responsive">
								...
								<tbody>
									<?php foreach($property as $p_row){ ?>
										<tr>
											...
											<?php
											if($p_row['deleted']==1 || $p_row['is_nlm']==1){
											...
											<?php
												if(!empty($p_row['prop_service'])){
													foreach($p_row['prop_service'] as $tt){
														...
														$service_type_icon = $this->system_model->display_job_icons($job_icon_params)."&nbsp;&nbsp;&nbsp;"; ?>

														<div class="service_type_icon"><?php echo $service_type_icon; ?></div>

														<!-- get service types -->
														<input type="hidden" class="prop_service_type" value="<?php echo $tt['alarm_job_type_id']; ?>" />
														<input type="hidden" class="prop_service_name" value="<?php echo $tt['type']; ?>" />
														<?php
														...
														?>
														<input type="hidden" class="price_variation_breakdown" value="<?php echo $price_var_arr['price_breakdown_text']; ?>" />
														<input type="hidden" class="dynamic_price_total" value="<?php echo number_format($price_var_arr['dynamic_price_total'],2); ?>" />
							...
							<div id="mbm_box">
								<div class="text-right">
									<p>
										<strong>
											Are you assigning a <a href="#" data-val="change_pm" class="btn_assign">Property Manager</a>, 
											<a href="#" data-val="change_agency" class="btn_assign">Changing Agency</a> or
											<a href="javascript:void(0);" id="change_prop_and_job_service_btn" class="btn_assign">Changing Property and Job Service?</a>
										</strong>
									</p>
								</div>
