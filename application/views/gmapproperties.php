...
<script src="https://maps.googleapis.com/maps/api/js?libraries=places&key=<?=config_item('gmap_api_key');?>"></script>
     ...
     bounds.extend(marker.position);    
      ...
      if (props.content) {
        var infoWindow = new google.maps.InfoWindow({
          content: '<h3><a href="/properties/details/?id='+props.property_id+'" target="blank">'+props.address_1+' '+props.address_2+', '+props.address_3+'</a></h3>'+
