...
.move{
 ...
 #edit-goal-form table,  #edit-goal-form table tr,  #edit-goal-form table th,  #edit-goal-form table td{
    border:none;
 }
 #edit-goal-form table th{
    text-align: left;
 }
</style>
		...
		<div class="body-typical-body">
			...
			<div class="table-responsivess" style="padding-top:0px;">
                ...
                <div style="margin-bottom: 10px;">
                    <a data-auto-focus="false" data-fancybox data-type="ajax" href="javascript:;" data-src="/home/ajax_get_goal_count_data" class="btn btn fancybox" id="edit-goal">Update Goals & Assign Task Manager</a>
                    &nbsp;&nbsp;
                    <?php 
                ...
                <div style="margin-top:40px;">
					...
					<?php else: ?>
                        <p class="text-center">No blocks assigned yet. Please contact admin.</p>
					<?php endif; ?>
                </div>
