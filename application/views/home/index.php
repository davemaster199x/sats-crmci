...
.timezone_main_div .time_div{
 ...
 <div class="row">
	                ...
	                <div class="row" id="sort_div_a">
						...
						<div class="col-sm-3 tt_sort_a" data-val='1'>
							<a href="/jobs/to_be_booked" target="_blank">
								...
								<?php echo $this->users_model->get_main_staff('to-be-booked'); ?>
						...
						<div class="col-sm-3 tt_sort_a" data-val='2'>
							<a href="/jobs/to_be_booked/?&updated_to_240v_rebook=1" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('240v-rebook'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='3'>
							<a href="/jobs/to_be_booked/?job_type_filter=Fix%20or%20Replace&custom_filter=j.status%20IN%20(%27To%20Be%20Booked%27,%27Allocate%27)&job_status_filter=-1" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('fix-or-replace'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='4'>
							<a href="/jobs/to_be_booked/?show_is_eo=1" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('electrician-only'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='5'>
							<a href="/daily/overdue_nsw_jobs" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('nsw-overdue'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='6'>
								<a href="/jobs/dha" target="_blank">
									<section class="widget widget-simple-sm widget_home_tot">
									<?php echo $this->users_model->get_main_staff('dha-to-be-booked'); ?>
										<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='7'>
							<a href="/reports/dirty_address/" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('dirty-address'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='8'>
							<a href="/daily/multiple_jobs" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('multiple-jobs'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='9'>
							<a href="/daily/duplicate_visit">
								<section class="widget widget-simple-sm widget_home_tot">
								<span><?php echo $this->users_model->get_main_staff('duplicate-visit'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='10'>
							<a href="/reports/properties_with_coordinates_errors" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('coordinate-errors'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='11'>
							<a href="/daily/active_unsold_services" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('unsold-services'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='12'>
							<a href="/daily/no_job_types" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('no-job-type'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='13'>
							<a href="/daily/no_job_status" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('no-job-status'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='14'>
							<a href="/reports/no_retest_date_property" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('no-retest-date'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='15'>
							<a href="/daily/incorrectly_upgraded_properties" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('data-discrepancy'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='16'>
							<a href="/daily/unserviced" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('unserviced-properties'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='17'>
							<a href="/properties/properties_with_multiple_services" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('multiple-service'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='18'>
							<a href="/daily/view_no_active_job_properties" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('no-active-job'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number"><?php $this->users_model->get_no_active_job(); ?></div>
						...
						<div class="col-sm-3 tt_sort_a" data-val='19'>
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('dha-completed-last-365-days'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='20'>
								...
								<?php echo $this->users_model->get_main_staff('jobs-since-june-2021'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='21'>
							<a href="/agency/agency_audits" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('agency-audits-not-completed'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='22'>
							<a href="#" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('new-agency-list'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='50'>
							<a href="/daily/active_properties_without_jobs" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('active-properties-without-jobs'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<?php if( in_array(51,$tt_rr) ){ ?>
						<div class="col-sm-3 tt_sort_a" data-val='51'>
							<a href="/daily/view_last_contact" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('last-contact'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number"><?php $this->users_model->get_main_count('last-contact'); ?></div>
										<div class="caption color-blue">Last Contact</div>
									</div>
									<div class="widget-simple-sm-bottom statistic"><strong>Target - </strong><strong class="goal_num"><?php $this->users_model->get_main_goal('last-contact'); ?></strong></div>
								</section>
							</a>
	                    </div><!--.col-->
						<?php } ?>
						...
						<div class="col-sm-3 tt_sort_a" data-val='33'>
							<a href="/jobs/platform_invoicing" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('dha-to-be-invoiced'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='34'>
							<a href="/jobs/platform_invoicing" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('platform-invoicing'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='35'>
							<a href="/sms/view_incoming_sms" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('incoming-sms'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number">
											<?php 
											//$this->users_model->get_main_count('incoming-sms'); 
											echo $this->system_model->get_page_total('/sms/view_incoming_sms');
											?>
										</div>
						...
						<div class="col-sm-3 tt_sort_a" data-val='36'>
							<a href="/credit/credit_request_summary" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('credit-request'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='37'>
							<a href="/credit/refund_request_summary" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('refund-request'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='38'>
							<a href="/jobs/to_be_invoiced" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('to-be-invoiced'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='39'>
							<a href="/jobs/new_jobs" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('new-jobs'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='40'>
							<a href="/jobs/bne_to_call" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('office-to-call'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number">
											<?php 
											//$this->users_model->get_main_count('office-to-call'); 
											echo $this->system_model->get_page_total('/jobs/bne_to_call');
											?>
										</div>
						...
						<div class="col-sm-3 tt_sort_a" data-val='41'>
							<a href="/jobs/allocate" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('to-be-allocated'); ?>
									<div class="widget-simple-sm-statistic">
						...
						<div class="col-sm-3 tt_sort_a" data-val='42'>
							<a href="/daily/missing_region" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('missing-region'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number"><?php 
						...
						<div class="col-sm-3 tt_sort_a" data-val='43'>
							<a href="/properties/duplicate_properties" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('duplicate-properties'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number"><?php 
						...
						<div class="col-sm-3 tt_sort_a" data-val='44'>
							<a href="/jobs/escalate" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('escalate'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number"><?php 
						...
						<div class="col-sm-3 tt_sort_a" data-val='45'>
							<a href="/daily/action_required_jobs" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('action-required'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number"><?php 
						...
						<div class="col-sm-3 tt_sort_a" data-val='46'>
							<a href="/property_me/properties_needs_verification" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('properties-need-verification'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number"><?php 
						...
						<div class="col-sm-3 tt_sort_a" data-val='47'>
							<a href="/jobs/to_be_booked?is_sales=1" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('sales-upgrade-to-be-booked'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number"><?php 
						...
						<div class="col-sm-3 tt_sort_a" data-val='48'>
							<a href="#" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('ready-to-be-mapped'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number"><?php 
						...
						<div class="col-sm-3 tt_sort_a" data-val='49'>
							<a href="#" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('call-over-complete'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number"><?php 
						...
						<?php if( in_array(52,$tt_rr) ){ ?>
						<div class="col-sm-3 tt_sort_a" data-val='52'>
							<a href="/console/tenants_info" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('console-tenants'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number"><?php 
										echo $this->users_model->get_main_count('console-tenants');
										?></div>
										<div class="caption color-blue">Console Tenants</div>
									</div>
									<div class="widget-simple-sm-bottom statistic"><strong>Target - </strong><strong class="goal_num"><?php $this->users_model->get_main_goal('console-tenants'); ?></strong></div>
								</section>
							</a>
	                    </div><!--.col-->
						<?php } ?>
						...
						$mpt_name = 'sales-sms';
						$box_text = 'Sales SMS';
						$link = '/sms/workorders_and_unlinked_sms/?sms_ref_id=1';
						if( in_array($hcb_id,$tt_rr) ){ ?>

							<div class="col-sm-3 tt_sort_a" data-val='<?php echo $hcb_id; ?>'>
								<a href="<?php echo $link; ?>" target="_blank">
									<section class="widget widget-simple-sm widget_home_tot">
										<?php echo $this->users_model->get_main_staff($mpt_name); ?>
										<div class="widget-simple-sm-statistic">
											<div class="number">
												<?php 
												// query
												$sms_ref_id = 1; // Sales Upgrade Requests
												$query = $this->db->query("
												SELECT COUNT(`sms_api_replies_id`) AS sar_count
												...
												$page_tot_params = array(
													'name' => $mpt_name,
													'total' => $query->row()->sar_count
												);
												$this->system_model->update_main_page_total($page_tot_params);

												echo $this->users_model->get_main_count($mpt_name);
												?>
											</div>
											<div class="caption color-blue"><?php echo $box_text; ?></div>
										</div>
										<div class="widget-simple-sm-bottom statistic">
											<strong>Target - </strong><strong class="goal_num">
												<?php $this->users_model->get_main_goal($mpt_name); ?>
											</strong>
										</div>
						...
						// Unlinked SMS
						$hcb_id = 54; 
						$mpt_name = 'unlinked-sms';
						$box_text = 'Unlinked SMS';
									...
									<section class="widget widget-simple-sm widget_home_tot">
										...
										<div class="widget-simple-sm-statistic">
											<div class="number">
												<?php
                                                /**
                                                 * I have updated the query to match with unlinked sms page
                                                 * this is the one causing the box container to not show the correct count
                                                 * RE: https://crmci.sats.com.au/reports/ticket_details/?id=1488
                                                 */
												// query
												$sms_ref_id = 2; // SATS Tenant Line
												$query = $this->db->query("											
                                                    SELECT COUNT(sar.sms_api_replies_id) AS sar_count 
                                                    FROM `sms_api_replies` AS `sar`
                                                    LEFT JOIN `sms_number_reference` AS `snr` ON sar.`sms_ref_id` = snr.`sms_ref_id`
                                                    WHERE `sar`.`active` = 1
                                                    AND `sar`.`message_id` IS NULL
													AND sar.`unread` = 1
                                                    ORDER BY `sar`.`created_date` DESC
												");
						...
						<?php if( in_array(55,$tt_rr) ){ ?>
						<div class="col-sm-3 tt_sort_a" data-val='55'>
							<a href="/daily/overdue_qld_jobs" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('overdue-qld-jobs'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number"><?php $this->users_model->get_main_count('overdue-qld-jobs'); ?></div>
										<div class="caption color-blue">Overdue QLD jobs</div>
									</div>
									<div class="widget-simple-sm-bottom statistic"><strong>Target - </strong><strong class="goal_num"><?php $this->users_model->get_main_goal('overdue-qld-jobs'); ?></strong></div>
								</section>
							</a>
						</div><!--.col-->
						<?php } ?>

						<?php if( in_array(56,$tt_rr) ){ ?>
						<div class="col-sm-3 tt_sort_a" data-val='56'>
							<a href="/property_me/supplier_pme" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('propertyMe-API-waiting-to-connect'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number">
											<?php 
											//update main_page_total query
											$pme_token_params = array(
												'sel_query' => "COUNT(a.agency_id) AS a_count",
												'active'        => 1,
												'api_id'        => 1,
												'group_by'      => 'agen_api_tok.`agency_id`',
												'join_table'    => array('agency'),
												'custom_where'  => "a.pme_supplier_id=''"
											);
											$pme_total = $this->api_model->get_agency_api_tokens($pme_token_params);

											$page_tot_params = array(
												'name' => "propertyMe-API-waiting-to-connect",
												'total' => ($pme_total->row()->a_count > 0) ? $pme_total->row()->a_count : 0
											);
											$this->system_model->update_main_page_total($page_tot_params);

											//show total count
											$this->users_model->get_main_count('propertyMe-API-waiting-to-connect'); 
											?>
										</div>
										<div class="caption color-blue">PropertyMe API - Waiting to Connect</div>
									</div>
									<div class="widget-simple-sm-bottom statistic"><strong>Target - </strong><strong class="goal_num"><?php $this->users_model->get_main_goal('propertyMe-API-waiting-to-connect'); ?></strong></div>
								</section>
							</a>
						</div><!--.col-->
						<?php } ?>

						<?php if( in_array(57,$tt_rr) ){ ?>
						<div class="col-sm-3 tt_sort_a" data-val='57'>
							<a href="/property_tree/connect_agency" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
									<?php echo $this->users_model->get_main_staff('property-tree-API-waiting-to-connect'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number">
											<?php 
											//update total query

											//show total count > I used page_total because it has page
											echo $this->system_model->get_page_total('/property_tree/connect_agency');
											?>
										</div>
										<div class="caption color-blue">Property Tree API - Waiting to Connect</div>
									</div>
									<div class="widget-simple-sm-bottom statistic"><strong>Target - </strong><strong class="goal_num"><?php $this->users_model->get_main_goal('property-tree-API-waiting-to-connect'); ?></strong></div>
								</section>
							</a>
						</div><!--.col-->
						<?php } ?>

						<!-- Create new Service Due bubble count -->
						<?php if( in_array(58,$tt_rr) ){ ?>
						<div class="col-sm-3 tt_sort_a" data-val='58'>
							<a href="/jobs/service_due" target="_blank">
								<section class="widget widget-simple-sm widget_home_tot">
								<?php echo $this->users_model->get_main_staff('service-due'); ?>
									<div class="widget-simple-sm-statistic">
										<div class="number"><?php echo $this->system_model->get_page_total('/jobs/service_due'); ?></div>
										<div class="caption color-blue">Service Due</div>
									</div>
									<div class="widget-simple-sm-bottom statistic"><strong>Target - </strong><strong class="goal_num"><?php $this->users_model->get_main_goal('service-due'); ?></strong></div>
								</section>
							</a>
						</div>
						<?php } ?>

							<!-- Deactivated Agency Jobs homepage tile -->
							<?php if( in_array(59,$tt_rr) ){ ?>
							<div class="col-sm-3 tt_sort_a" data-val='59'>
								<a href="/jobs/deactivated_agencies_with_active_jobs" target="_blank">
									<section class="widget widget-simple-sm widget_home_tot">
									<?php echo $this->users_model->get_main_staff('deactivated-agency-jobs'); ?>
										<div class="widget-simple-sm-statistic">
											<div class="number"><?php echo $this->system_model->get_page_total('/jobs/deactivated_agencies_with_active_jobs'); ?></div>
											<div class="caption color-blue">Deactivated Agency Jobs</div>
										</div>
										<div class="widget-simple-sm-bottom statistic"><strong>Target - </strong><strong class="goal_num"><?php $this->users_model->get_main_goal('deactivated-agency-jobs'); ?></strong></div>
									</section>
								</a>
							</div>
							<?php } ?>

							<!-- API Property Needs Connecting | Count from page /reports/api_unlinked_properties-->
							<?php if( in_array(61,$tt_rr) ){ ?>
							<div class="col-sm-3 tt_sort_a" data-val='61'>
								<a href="/reports/api_unlinked_properties" target="_blank">
									<section class="widget widget-simple-sm widget_home_tot">
									<?php echo $this->users_model->get_main_staff('api-property-needs-connecting'); ?>
										<div class="widget-simple-sm-statistic">
											<div class="number"><?php echo $this->system_model->get_page_total('/reports/api_unlinked_properties'); ?></div>
											<div class="caption color-blue">API Property Needs Connecting</div>
										</div>
										<div class="widget-simple-sm-bottom statistic"><strong>Target - </strong><strong class="goal_num"><?php $this->users_model->get_main_goal('api-property-needs-connecting'); ?></strong></div>
									</section>
								</a>
							</div>
							<?php } ?>
	        ...
	        <div class="row" id="sort_div_b">
						...
						<div class="col-xl-6 dahsboard-column"> -->
							...
							<section class="box-typical box-typical-dashboard panel panel-default greeting_panel">	
								...
								<div class="box-typical-body panel-body">
									...
									Good <span class='junderline_colored'>morning/afternoon</span>, <?=config_item('company_full_name');?>. You're speaking with <?php echo $sa['FirstName']; ?><br /><br />
				...
				<div class="col-xl-12 dahsboard-column tt_sort_b" data-val='24'>
					...
					<section class="box-typical panel panel-default scrollable booking_sched_box" style="margin-bottom:30px;">	
						<header class="box-typical-header panel-heading">
							...
							<span class="booking_sched_tt_text">Booking Schedule <a href="/bookings/view_schedule" target="_blank"><em class="fa fa-external-link-square"></em></a></span>							
							<span class="booking_sched_tt_text">Planner <a href="<?php echo config_item('company_planner_url');?>" target="_blank"><em class="fa fa-external-link-square"></em></a></span>
	                    </header>
				...
				<div class="col-xl-6 dahsboard-column tt_sort_b" data-val='30'>		
					<section class="box-typical box-typical-dashboard panel panel-default greeting_panel">	
						<header class="box-typical-header panel-heading">
							...
							<div style="float:right;"><span><small>Last Updated: <?php echo date("d/m/Y @ H:i",strtotime($notice_board['date_updated'])); ?></small></span> <a href="/admin/noticeboard">Update</a></div>
						</header>
						<div class="box-typical-body panel-body">
				...
				<?php if( in_array(60,$tt_rr2) ){ ?>
				<div class="col-xl-6 dahsboard-column tt_sort_b" data-val='60'>
					<section class="box-typical box-typical-dashboard panel panel-default scrollable">
	                    <header class="box-typical-header panel-heading">
	                    ...
	                    <div class="box-typical-body panel-body">
	                        <div class="notice_box">
								...
								<p><b>Customer Service</b> - Customer needs are our priority. We look to deliver the best outcome every time with the customer at the core of our actions.</p>
								<p><b>Make it happen</b> - Getting the right result matters. We embrace each day with enthusiasm and commitment to create exceptional outcomes.</p>
								<p><b>Humility</b> - Listening to understand different views is crucial. We don’t think less of ourselves, we think of ourselves less.</p>
								<p><b>Persistence</b> - We commit to excellence every day. With a tenacious and playful spirit, we are motivated to be better than yesterday.</p>
