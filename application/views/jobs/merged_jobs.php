        ...
        <div class="tabs-section-nav tabs-section-nav-icons">
            <div class="tbl">
                <ul class="nav" role="tablist" id="main-tab">
                    ...
                    <?php
                    // for SATS AU only
                    if( $_ENV['THEME'] == 'sats' && $this->config->item('country') == 1 ){ ?>
                        <li class="nav-item">
                ...
                <header class="box-typical-header">
                    ...
                    ?>
                        <div class="row">
                            ...
                            <div class="col-md-1 process_container">
                                <label>&nbsp;</label>
                                <button id="btn_process" class="btn btn-success" type="button">Process</button>
                            </div>

                            <div class="col-md-3">
                                <span>Page Crons: Mon-Sat (Every Hour, 7am-6pm)</span>
                                <ul class="mt-2" style="list-style-type: square;">
                                    <li>Cert/Invoice Emailed</li>
                                    <li>Cert/Invoice Pushed via API</li>
                                    <li>Thank you SMS Sent</li>
                                </ul>
                            </div>
                                    ...
                                    foreach ($lists_all->result_array() as $val) { 
                                        ...
                                        if (stristr($val['account_emails'], "@")) {
                                            if ($val['client_emailed'] != NULL) {} else {
                                                ...
                                                if( $val['exclude_free_invoices'] == 1 && $val['invoice_amount'] == 0 && $val['send_combined_invoice']==0 ){
                                                    $has_blue_tick = true;
                                                }
                                        ...
                                        <?php
                                            ...
                                            if (stristr($list_item['account_emails'], "@")) {
                                                if ($list_item['client_emailed'] != NULL) {
                                                    ...
                                                    // exclude free invoice
                                                    if( $list_item['exclude_free_invoices'] == 1 && $list_item['invoice_amount'] == 0 && $list_item['send_combined_invoice']==0 ){
                            ...
                            <table class="table table-hover main-table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="merge_rows api_tab_rows pme-table <?php echo ( $list_item['sms_sent_merge'] !='' )?'sms_sent_flag':null; ?>">
                                        ...
                                        }else if( $list_item['ptree_prop_id'] != '' && $list_item['ptree_api'] == 3 ) { // PropertyTree
                                            $bubTxt = ' <span class="badge badge-primary">PropertyTree</span>';
                                        ...
                                        <td class="text-center chops">
                                            <?php 
                                                ...
                                                if( $list_item['pme_prop_id'] != '' && $list_item['pme_api'] == 1 ) { // PMe
                                                    ...
                                                    $invoice_upload = $list_item['ajd_pt_api_inv_uploaded'];
                                                    $bill_create = $list_item['ajd_pt_api_cert_uploaded'];
                                                }else if( !is_null($list_item['crm_prop_id']) && $list_item['crm_prop_id'] !== '' ) { // console
                    ...
                    function(isConfirm){
                        if(isConfirm){
                                ...
                                jQuery.ajax({
                                    ...
                                    url: "/jobs/dynamic_merged_jobs_send_api_invoices",
