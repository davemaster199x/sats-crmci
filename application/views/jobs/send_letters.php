...
<div id="about_page_fb" class="fancybox" style="display:none;" >
	...
	<p>
	This page displays all new jobs that come into the system that have never been in the system before. This page notifies the tenant via SMS or Email of who <?=$this->config->item('company_name_short')?> is to prepare them before we attempt to book the job in.
	</p>
