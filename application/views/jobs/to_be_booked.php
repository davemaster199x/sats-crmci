		...
		?>
			<div class="for-groupss row">
				...
				<div class="row mt-2 ml-2">
					<div class="col">		
						<div id="sub_region_tag_div">
							<?php
							if( $sub_region_ms_tag_imp != '' ){
								...
								SELECT 
									...
									`subregion_name`
								FROM `sub_regions`
								WHERE `sub_region_id` IN({$sub_region_ms_tag_imp})
								");									
					...
					<tbody>
						...
						<tr class="tbl_list_tr <?php echo $row_color; ?>">
							...
							<?php
								...
								echo $this->gherxlib->crmLink('vpd',$list_item['prop_id'],$prop_address,'','',$row_color);
							?>
							<td>
                            ...
                            <td>
							<?php echo $this->gherxlib->crmLink('vjd',$list_item['jid'],$list_item['jid'],'','',$row_color);?></td>
                            <td>
								<?php
...
jQuery(document).ready(function(){
	...
	var multi_sel_chk = jQuery('.chk_job:visible'); // checkbox DOM
