                ...
                <tbody>
                    ...
                    if($lists->num_rows()>0){
                        ...
                        foreach($lists->result_array() as $list_item){ 	
                            ...
                            // API catch copied from precomp page, and remove unnecessary code
                            // Pme API                             
                            if( $current_tab == 'ar_tab' && ( $list_item['access_token'] != '' && $list_item['pme_supplier_id'] != '' && $list_item['pme_prop_id'] == '' ) ){

                                $reason .= "
                                <br />
                                <a href='/property_me/property/{$list_item['property_id']}/{$list_item['agency_id']}'>
                            ...
                            // Palace API 
                            if( $current_tab == 'ar_tab' && ( $list_item['access_token'] != '' && $list_item['palace_diary_id'] != '' && $list_item['palace_prop_id'] == '' ) ){

                                $reason .= "
                                <br />
                                <a href='/palace/property/{$list_item['property_id']}/{$list_item['agency_id']}'>
                            ...
                            // PropertyTree API 
                            if( $current_tab == 'ar_tab' && ( $list_item['access_token'] != '' && $list_item['ptree_prop_id'] == '' ) ){

                                $reason .= "
                                <br />
                                <a href='/property_tree/connection_details/{$list_item['property_id']}'>
                        ...
                        <tr class="body_tr jalign_left <?php echo $row_color; ?> <?php echo ($is_no_tenants==1)?'no_tenants_row':'tenant_present_row'; ?> <?php echo ($has_tenant_email==1)?'has_tenants_email_row':'no_tenants_email_row'; ?> <?php echo ($has_mobile_num==1)?'has_mobile_num_row':'no_mobile_num_row'; ?>">
                            ...
                            <td>
                                ...
                                <?php echo ( $reason != '' )?"<br />{$reason}":null; ?>
                            </td>
                            <td>
                                <?php 
