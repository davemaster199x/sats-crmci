					...
					<div class="row">
						...
						<div class="col-mdd-3" style="min-width:195px;">
							...
							<select name="tsa_filter" class="form-control">
								...
								<?php foreach( $row['tas_sql'] as $tsa_row ):?>
	...
	<section>
		<div class="body-typical-body">
			<div class="table-responsive">
				...
				<table class="table table-hover main-table escalate_tbl" id="datatable">
					<thead>
						<tr>
							<?php 
								//count total jobs
							...
							?>
							<th>Jobs 
								<span class="label label-custom label-pill label-danger bubble_count"><?=$total_jobs?></span>
							</th>
							<th>Agency</th>
							<th>Phone</th>
							<th>Left Message</th>
					...
					<tbody>
						<?php foreach($lists->result_array() as $row): ?>
                        <?php
							...
							if($row['save_notes']==1){
								...
								$escalate_notes_ts = ( !empty($row['escalate_notes_ts']) ) ? date('d/m/Y H:i',strtotime($row['escalate_notes_ts'])) : '';
								...
								$escalate_notes_ts = ( !empty($eai_sql['notes_timestamp']) ) ? date("d/m/Y H:i",strtotime($eai_sql['notes_timestamp'])):'';
						...
						<tr class="<?php echo $row_class; ?>">
							...
							<td>
								<?php if($row['trust_account_software']!=0): ?>
							...
							<td>							
								<span class="txt_green">
									<?php echo $api_token_row->api_name; ?>
								</span>
							</td>
                        </tr>
                        <?php endforeach; ?>
