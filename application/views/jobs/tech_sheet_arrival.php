                    ...
                    <tr>
                        ...
                        if( $job_row->booked_with != 'Agent' ){
                            ...
                            if( $job_row->job_entry_notice == 1 ){
                                echo "Booked via Entry Notice on ".date('d/m/Y',strtotime($job_row->en_date_issued))." <b>@{$job_row->time_of_day}</b>";
...
<table class="table main-table">
    ...
    <tbody>
        <tr>
            <td>   
                <span class="j_comments_span" style="word-break: break-all;">
