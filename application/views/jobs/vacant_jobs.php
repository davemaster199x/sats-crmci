			...
			<div class="table-responsive">
				<table class="table table-hover main-table" id="sortTable">
					...
					<tbody>
						...
						$tdf_start_date = date("Y-m-d",strtotime($list_item['job_vacant_dates_start_date']." -3 days"));
						$tdf_end_date = date("Y-m-d",strtotime($list_item['job_vacant_dates_end_date']." -3 days")); 
						...
						// green
						if( $this->system_model->isDateNotEmpty($list_item['job_vacant_dates_end_date']) && date("Y-m-d") >= $tdf_end_date ){
						...
						if( !$this->system_model->isDateNotEmpty($list_item['job_vacant_dates_start_date']) && !$this->system_model->isDateNotEmpty($list_item['job_vacant_dates_end_date']) && $list_item['no_dates_provided'] == 0 ){
							$row_color = "redRowBg";
						}
						
						// white
						// if start/end date is empty and N/A
						if( !$this->system_model->isDateNotEmpty($list_item['job_vacant_dates_start_date']) && !$this->system_model->isDateNotEmpty($list_item['job_vacant_dates_end_date']) && $list_item['no_dates_provided'] == 1  ){
							$row_color = "whiteRowBg";
						}
						...
						<tr class="<?php echo $row_color; ?>">
							<td>
							<span class="dateSort"><?php echo $list_item['job_vacant_dates_start_date']; ?></span>
							<?php 
								echo ($this->system_model->isDateNotEmpty($list_item['job_vacant_dates_start_date']))?date('d/m/Y', strtotime($list_item['job_vacant_dates_start_date'])):'N/A'; 
							?>
							</td>
							<td>
							<span class="dateSort"><?php echo $list_item['job_vacant_dates_end_date']; ?></span>
							<?php 
								echo ($this->system_model->isDateNotEmpty($list_item['job_vacant_dates_end_date']))?date('d/m/Y', strtotime($list_item['job_vacant_dates_end_date'])):"N/A"; 
							?>
							</td>
							<td>
							<?php 
