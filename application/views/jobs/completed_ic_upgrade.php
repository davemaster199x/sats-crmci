				...
				<table class="table table-hover main-table">
					...
					<tbody>
						...
						if($this->input->get_post('search_submit')){
							...
							<tr>
								<td>
									<a href="<?php echo $this->config->item("crmci_link"); ?>/jobs/details/<?php echo $list_item['jid']; ?>">
...
<div id="about_page_fb" class="fancybox" style="display:none;" >
	...
	<p>This report needs to show any actual upgrades completed regardless if client with <?=$this->config->item('company_name_short')?> any longer. All prices are exclusive of GST.</p>
<pre>
