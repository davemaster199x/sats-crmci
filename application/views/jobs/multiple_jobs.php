					...
					<div class="row">	
                        ...
                        <div class="col-md-2">
							...
							<select id="agency_filter" name="agency_filter"  class="form-control field_g2">
                                ...
                                <?php foreach($agency_lists as $agency_row): ?>
                                    <option value="<?= $agency_row->agency_id ?>"><?= $agency_row->agency_name ?></option>
                                <?php endforeach; ?>
							</select>							
						</div>
                        <!-- <div class="col-md-2">
        ...
        <div class="table-responsive">
            <table class="table table-hover main-table">
                ...
                ?>
                    ...
                    <?php 
                        $dup_sql2 = $this->daily_model->getOtherMultipleJobs($d['property_id'],$d['id'],$d['jservice']);
