							...
							<td>
								<?php 
									 ...
									 if( $list_item['pme_prop_id'] != ''  ){
										echo "<a target='_blank' href='/properties/details/?id={$list_item['prop_id']}&amp;tab=1'><img height='30' class='reason_icon' src='/images/third_party/Pme.png' /></a>";
									}
						
									// Palace API check
									if( $list_item['palace_prop_id'] != '' ){
										echo  "<a target='_blank' href='/properties/details/?id={$list_item['prop_id']}&amp;tab=1'><img height='30' class='reason_icon' src='/images/third_party/Palace.png' /></a>";
									}
