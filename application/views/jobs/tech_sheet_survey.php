    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <input type="hidden" name="ps_theme" class="form-control ps_theme" id="ps_theme" data-db_table_field="ps_theme" data-db_table="jobs" value="<?php echo config_item('theme'); ?>" />
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <table id="swms_table" class="table main-table borderless my-3">
                    ...
                    <tr target="_blank">
                        ...
                        <td>
                            <a href="/pdf_swms.php?id=<?php echo $this->input->get_post('job_id'); ?>&swms_type=heights">
                    ...
                    <tr>
                        <td><label class="inline-block">Working at Heights</label></td>
                        <td>
                            <a href="/pdf/swms/<?php echo $this->uri->segment('3'); ?>/heights" target="_blank">
                                <img src="/images/pdf.png" class="inline-block" />
                            </a>                                                            
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <a href="/pdf/swms/<?php echo $this->uri->segment('3'); ?>/uv_protection" target="_blank">
                                <img src="/images/pdf.png" class="inline-block" />
                            </a>   
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <a href="/pdf/swms/<?php echo $this->uri->segment('3'); ?>/asbestos" target="_blank">
                                <img src="/images/pdf.png" class="inline-block" />
                            </a> 
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <a href="/pdf/swms/<?php echo $this->uri->segment('3'); ?>/powertools" target="_blank">
                                <img src="/images/pdf.png" class="inline-block" />
                            </a> 
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <a href="/pdf/swms/<?php echo $this->uri->segment('3'); ?>/animals" target="_blank">
                                <img src="/images/pdf.png" class="inline-block" />
                            </a> 
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <a href="/pdf/swms/<?php echo $this->uri->segment('3'); ?>/live_circuits" target="_blank">
                                <img src="/images/pdf.png" class="inline-block" />
                            </a> 
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <a href="/pdf/swms/<?php echo $this->uri->segment('3'); ?>/covid_19" target="_blank">
                                <img src="/images/pdf.png" class="inline-block" />
                            </a> 
                        </td>
                    </tr>                                  
