...
class Customlib {
	...
	function getLastCompletedJob($propertyId){
		...
		//$exclude_tech = array(1, 2);
		$exclude_tech = array(2);
		$this->CI->db->where_not_in('j.assigned_tech', $exclude_tech);
     ...
     * @return string
     */
    public function getAllowEnValues($value): string
    {
        $from = '';
        switch ($value) {
            case 1:
     ...
     * @return string
     */
    public function getColumnNamesByAlias(string $str = ""): string
    {
