...
// get agency details
        ...
        if ($this->PageNo() == 1) {
            ...
            if ($this->CI->config->item('theme') == 'sas') {
              $image = '/theme/pdf_templates/sas/sas_header.png';
              $this->Image($this->path . $image, 0, 0, 210);
            } else {
              if ($this->country_id == 1) { // AU
            ...
            $country_email =  make_email('accounts');
    ...
    function Footer() {
      ...
      if ($this->CI->config->item('theme') == 'sas') {
        $image = '/theme/pdf_templates/sas/sas_footer.png';
        $this->Image($this->path . $image, 2, 243, 208);
      } else {
        if ($this->country_id == 1) { // AU
        ...
        $this->Image($this->path . $image, 0, 273, 208);
      }
