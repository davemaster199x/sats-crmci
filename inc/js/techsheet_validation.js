function tab_step_validation(required_radio){
    ...
    if(next.length){
        ...
        var staff_class = jQuery("#staff_class").val();
        ...
        if( current_tab == 'Survey' ){
            ...
            var ps_theme = jQuery("#ps_theme").val();  
        ...
        if( current_tab == 'Tech Sheet' ){
            ...
            if( all_alarm_count == 0 ){
                ...
                if( staff_class == 6 ){ // tech, do not proceed

                    error += '<li>Cannot continue without alarms</li>'; 
                    can_continue = false;            
                ...
                var has_ss_view_only = jQuery("#has_ss_view_only").val();

                if( has_ss_view_only != 1 ){
            ...
            if( jQuery("#has_cw").val() == 1 ){ 
                ...
                if( we_toilet == 0 ){
                    ...
                    error += '<li>Corded Window is Empty.</li>';  
                    // can_continue = true;
                }
